@STATIC;1.0;p;12;Foundation.jt;3063;@STATIC;1.0;i;9;CPArray.ji;10;CPBundle.ji;9;CPCoder.ji;8;CPData.ji;8;CPDate.ji;14;CPDictionary.ji;14;CPEnumerator.ji;13;CPException.ji;13;CPFormatter.ji;12;CPIndexSet.ji;14;CPInvocation.ji;17;CPKeyedArchiver.ji;19;CPKeyedUnarchiver.ji;18;CPKeyValueCoding.ji;21;CPKeyValueObserving.ji;16;CPMutableArray.ji;14;CPMutableSet.ji;16;CPNotification.ji;22;CPNotificationCenter.ji;8;CPNull.ji;10;CPNumber.ji;10;CPObject.ji;15;CPObjJRuntime.ji;29;CPPropertyListSerialization.ji;9;CPRange.ji;11;CPRunLoop.ji;7;CPSet.ji;18;CPSortDescriptor.ji;10;CPString.ji;9;CPTimer.ji;15;CPUndoManager.ji;7;CPURL.ji;17;CPURLConnection.ji;14;CPURLRequest.ji;15;CPURLResponse.ji;9;CPValue.ji;20;CPValueTransformer.jt;2369;
...
var _73=_70[i];
if(_73===null){
_71.push(objj_msgSend(CPNull,"null"));
}else{
...
p;13;CPArray+KVO.jt;13563;@STATIC;1.0;i;9;CPArray.ji;8;CPNull.jt;13518;
objj_executeFile("CPArray.j",YES);
objj_executeFile("CPNull.j",YES);
var _1=objj_getClass("CPObject");
if(!_1){
...
var _69=[];
var _7a,_7b,_7c,_7d,_7e,_7f,_80;
_69["avg"]=_7a=function(_81,_82,_83){
var _84=objj_msgSend(_81,"valueForKeyPath:",_83),_85=objj_msgSend(_84,"count"),_86=_85,_87=0;
if(!_85){
return 0;
}
while(_86--){
_87+=objj_msgSend(_84[_86],"doubleValue");
}
return _87/_85;
};
_69["max"]=_7b=function(_88,_89,_8a){
var _8b=objj_msgSend(_88,"valueForKeyPath:",_8a),_8c=objj_msgSend(_8b,"count")-1,max=objj_msgSend(_8b,"lastObject");
while(_8c--){
var _8d=_8b[_8c];
if(objj_msgSend(max,"compare:",_8d)<0){
max=_8d;
}
}
return max;
};
_69["min"]=_7c=function(_8e,_8f,_90){
var _91=objj_msgSend(_8e,"valueForKeyPath:",_90),_92=objj_msgSend(_91,"count")-1,min=objj_msgSend(_91,"lastObject");
while(_92--){
var _93=_91[_92];
if(objj_msgSend(min,"compare:",_93)>0){
min=_93;
}
}
return min;
};
_69["count"]=_7d=function(_94,_95,_96){
return objj_msgSend(_94,"count");
};
_69["sum"]=_7e=function(_97,_98,_99){
var _9a=objj_msgSend(_97,"valueForKeyPath:",_99),_9b=objj_msgSend(_9a,"count"),sum=0;
while(_9b--){
sum+=objj_msgSend(_9a[_9b],"doubleValue");
}
return sum;
};
_69["distinctUnionOfObjects"]=_7f=function(_9c,_9d,_9e){
var _9f=objj_msgSend(_9c,"valueForKeyPath:",_9e);
return objj_msgSend(objj_msgSend(CPSet,"setWithArray:",_9f),"allObjects");
};
_69["unionOfObjects"]=_80=function(_a0,_a1,_a2){
return objj_msgSend(_a0,"valueForKeyPath:",_a2);
};
var _1=objj_getClass("CPArray");
if(!_1){
throw new SyntaxError("*** Could not find definition for class \"CPArray\"");
...
var _2=_1.isa;
class_addMethods(_1,[new objj_method(sel_getUid("addObserver:toObjectsAtIndexes:forKeyPath:options:context:"),function(_a3,_a4,_a5,_a6,_a7,_a8,_a9){
with(_a3){
var _aa=objj_msgSend(_a6,"firstIndex");
while(_aa>=0){
objj_msgSend(_a3[_aa],"addObserver:forKeyPath:options:context:",_a5,_a7,_a8,_a9);
_aa=objj_msgSend(_a6,"indexGreaterThanIndex:",_aa);
}
}
}),new objj_method(sel_getUid("removeObserver:fromObjectsAtIndexes:forKeyPath:"),function(_ab,_ac,_ad,_ae,_af){
with(_ab){
var _b0=objj_msgSend(_ae,"firstIndex");
while(_b0>=0){
objj_msgSend(_ab[_b0],"removeObserver:forKeyPath:",_ad,_af);
_b0=objj_msgSend(_ae,"indexGreaterThanIndex:",_b0);
}
}
}),new objj_method(sel_getUid("addObserver:forKeyPath:options:context:"),function(_b1,_b2,_b3,_b4,_b5,_b6){
with(_b1){
if(objj_msgSend(isa,"instanceMethodForSelector:",_b2)===objj_msgSend(CPArray,"instanceMethodForSelector:",_b2)){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Unsupported method on CPArray");
}else{
objj_msgSendSuper({receiver:_b1,super_class:objj_getClass("CPArray").super_class},"addObserver:forKeyPath:options:context:",_b3,_b4,_b5,_b6);
}
}
}),new objj_method(sel_getUid("removeObserver:forKeyPath:"),function(_b7,_b8,_b9,_ba){
with(_b7){
if(objj_msgSend(isa,"instanceMethodForSelector:",_b8)===objj_msgSend(CPArray,"instanceMethodForSelector:",_b8)){
objj_msgSend(CPException,"raise:reason:",CPInvalidArgumentException,"Unsupported method on CPArray");
}else{
objj_msgSendSuper({receiver:_b7,super_class:objj_getClass("CPArray").super_class},"removeObserver:forKeyPath:",_b9,_ba);
}
}
})]);
...
p;17;CPKeyedArchiver.jt;10262;@STATIC;1.0;i;9;CPArray.ji;9;CPCoder.ji;8;CPData.ji;14;CPDictionary.ji;10;CPNumber.ji;10;CPString.ji;9;CPValue.jt;10142;
objj_executeFile("CPArray.j",YES);
objj_executeFile("CPCoder.j",YES);
objj_executeFile("CPData.j",YES);
objj_executeFile("CPDictionary.j",YES);
...
while(key=objj_msgSend(_5a,"nextObject")){
