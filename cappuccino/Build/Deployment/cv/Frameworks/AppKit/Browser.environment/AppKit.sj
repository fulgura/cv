@STATIC;1.0;p;8;AppKit.jt;4715;@STATIC;1.0;i;9;CPAlert.ji;13;CPAnimation.ji;15;CPApplication.ji;7;CPBox.ji;10;CPButton.ji;13;CPButtonBar.ji;12;CPCheckBox.ji;7;CPCib.ji;23;CPCibBindingConnector.ji;16;CPCibConnector.ji;23;CPCibControlConnector.ji;14;CPCibLoading.ji;22;CPCibOutletConnector.ji;33;CPCibRuntimeAttributesConnector.ji;12;CPClipView.ji;9;CPColor.ji;14;CPColorPanel.ji;17;CPCompatibility.ji;11;CPControl.ji;10;CPCookie.ji;10;CPCursor.ji;12;CPDocument.ji;22;CPDocumentController.ji;9;CPEvent.ji;8;CPFont.ji;12;CPGeometry.ji;12;CPGraphics.ji;9;CPImage.ji;13;CPImageView.ji;14;CPKeyBinding.ji;8;CPMenu.ji;12;CPMenuItem.ji;13;CPOpenPanel.ji;9;CPPanel.ji;14;CPPasteboard.ji;15;CPPopUpButton.ji;9;CPRadio.ji;13;CPResponder.ji;12;CPScroller.ji;14;CPScrollView.ji;10;CPShadow.ji;10;CPSlider.ji;13;CPSplitView.ji;8;CPText.ji;13;CPTextField.ji;11;CPToolbar.ji;15;CPToolbarItem.ji;8;CPView.ji;17;CPViewAnimation.ji;18;CPViewController.ji;10;CPWindow.ji;20;CPWindowController.jt;3765;
...
/* objj_executeFile("CPLevelIndicator.j",YES) */ (undefined);
...
/* objj_executeFile("CPPredicateEditor.j",YES) */ (undefined);
/* objj_executeFile("CPPredicateEditorRowTemplate.j",YES) */ (undefined);
/* objj_executeFile("CPProgressIndicator.j",YES) */ (undefined);
objj_executeFile("CPRadio.j",YES);
objj_executeFile("CPResponder.j",YES);
/* objj_executeFile("CPRuleEditor.j",YES) */ (undefined);
...
/* objj_executeFile("_CPToolTip.j",YES) */ (undefined);
/* objj_executeFile("CPTreeNode.j",YES) */ (undefined);
/* objj_executeFile("CPUserDefaultsController.j",YES) */ (undefined);
...
p;11;CPControl.jt;21010;@STATIC;1.0;i;27;../Foundation/CPFormatter.ji;8;CPFont.ji;10;CPShadow.ji;8;CPView.ji;19;CPKeyValueBinding.jt;20895;
...
p;8;CPView.jt;64332;@STATIC;1.0;I;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.jI;18;Foundation/CPSet.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;12;CPGeometry.ji;19;CPGraphicsContext.ji;13;CPResponder.ji;9;CPTheme.ji;18;_CPDisplayServer.jt;64084;
...
_DOMImageParts=[];
_DOMImageSizes=[];
_theme=objj_msgSend(CPTheme,"themeForView:",_1a);
...
}),new objj_method(sel_getUid("registerThemeValues:"),function(self,_1c6,_1c7){
with(self){
for(var i=0;i<_1c7.length;++i){
var _1c8=_1c7[i],_1c9=_1c8[0],_1ca=_1c8[1],_1cb=_1c8[2];
if(_1cb){
objj_msgSend(self,"setValue:forThemeAttribute:inState:",_1ca,_1c9,_1cb);
}else{
objj_msgSend(self,"setValue:forThemeAttribute:",_1ca,_1c9);
}
}
}
}),new objj_method(sel_getUid("registerThemeValues:inherit:"),function(self,_1cc,_1cd,_1ce){
with(self){
if(_1ce){
objj_msgSend(self,"registerThemeValues:",_1ce);
}
if(_1cd){
objj_msgSend(self,"registerThemeValues:",_1cd);
}
}
}),new objj_method(sel_getUid("createEphemeralSubviewNamed:"),function(self,_1cf,_1d0){
with(self){
return nil;
}
}),new objj_method(sel_getUid("rectForEphemeralSubviewNamed:"),function(self,_1d1,_1d2){
with(self){
return {origin:{x:0,y:0},size:{width:0,height:0}};
}
}),new objj_method(sel_getUid("layoutEphemeralSubviewNamed:positioned:relativeToEphemeralSubviewNamed:"),function(self,_1d3,_1d4,_1d5,_1d6){
with(self){
...
}),new objj_method(sel_getUid("ephemeralSubviewNamed:"),function(self,_1d8,_1d9){
with(self){
if(!_ephemeralSubviewsForNames){
return nil;
}
return (_ephemeralSubviewsForNames[_1d9]||nil);
}
})]);
class_addMethods(_d,[new objj_method(sel_getUid("defaultThemeClass"),function(self,_1da){
with(self){
return nil;
}
}),new objj_method(sel_getUid("themeAttributes"),function(self,_1db){
with(self){
return nil;
}
}),new objj_method(sel_getUid("_themeAttributes"),function(self,_1dc){
with(self){
if(!_2){
_2={};
}
var _1dd=objj_msgSend(self,"class"),_1de=objj_msgSend(CPView,"class"),_1df=[],_1e0=objj_msgSend(CPNull,"null");
for(;_1dd&&_1dd!==_1de;_1dd=objj_msgSend(_1dd,"superclass")){
var _1e1=_2[class_getName(_1dd)];
if(_1e1){
_1df=_1df.length?_1df.concat(_1e1):_1df;
_2[objj_msgSend(self,"className")]=_1df;
break;
}
var _1e2=objj_msgSend(_1dd,"themeAttributes");
if(!_1e2){
continue;
}
var _1e3=objj_msgSend(_1e2,"allKeys"),_1e4=_1e3.length;
while(_1e4--){
var _1e5=_1e3[_1e4],_1e6=objj_msgSend(_1e2,"objectForKey:",_1e5);
_1df.push(_1e6===_1e0?nil:_1e6);
_1df.push(_1e5);
}
}
return _1df;
...
var _1e7="CPViewAutoresizingMask",_1e8="CPViewAutoresizesSubviews",_1e9="CPViewBackgroundColor",_1ea="CPViewBoundsKey",_1eb="CPViewFrameKey",_1ec="CPViewHitTestsKey",_1ed="CPViewIsHiddenKey",_1ee="CPViewOpacityKey",_1ef="CPViewSubviewsKey",_1f0="CPViewSuperviewKey",_1f1="CPViewTagKey",_1f2="CPViewThemeClassKey",_1f3="CPViewThemeStateKey",_1f4="CPViewWindowKey",_1f5="CPViewNextKeyViewKey",_1f6="CPViewPreviousKeyViewKey";
var _c=objj_getClass("CPView");
if(!_c){
throw new SyntaxError("*** Could not find definition for class \"CPView\"");
}
var _d=_c.isa;
class_addMethods(_c,[new objj_method(sel_getUid("initWithCoder:"),function(self,_1f7,_1f8){
with(self){
_DOMElement=_3.cloneNode(false);
_frame=objj_msgSend(_1f8,"decodeRectForKey:",_1eb);
_bounds=objj_msgSend(_1f8,"decodeRectForKey:",_1ea);
self=objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPView").super_class},"initWithCoder:",_1f8);
if(self){
_tag=objj_msgSend(_1f8,"containsValueForKey:",_1f1)?objj_msgSend(_1f8,"decodeIntForKey:",_1f1):-1;
_window=objj_msgSend(_1f8,"decodeObjectForKey:",_1f4);
_subviews=objj_msgSend(_1f8,"decodeObjectForKey:",_1ef)||[];
_superview=objj_msgSend(_1f8,"decodeObjectForKey:",_1f0);
_registeredDraggedTypes=objj_msgSend(CPSet,"set");
_registeredDraggedTypesArray=[];
if(_autoresizingMask===nil){
_autoresizingMask=objj_msgSend(_1f8,"decodeIntForKey:",_1e7)||CPViewNotSizable;
}
_autoresizesSubviews=!objj_msgSend(_1f8,"containsValueForKey:",_1e8)||objj_msgSend(_1f8,"decodeBoolForKey:",_1e8);
_hitTests=!objj_msgSend(_1f8,"containsValueForKey:",_1ec)||objj_msgSend(_1f8,"decodeObjectForKey:",_1ec);
_DOMImageParts=[];
_DOMImageSizes=[];
if(NULL){
var _1f9={x:CGPointMake((_frame.origin.x),(_frame.origin.y)).x*NULL.a+CGPointMake((_frame.origin.x),(_frame.origin.y)).y*NULL.c+NULL.tx,y:CGPointMake((_frame.origin.x),(_frame.origin.y)).x*NULL.b+CGPointMake((_frame.origin.x),(_frame.origin.y)).y*NULL.d+NULL.ty};
}else{
var _1f9={x:(_frame.origin.x),y:(_frame.origin.y)};
}
_DOMElement.style.left=ROUND(_1f9.x)+"px";
_DOMElement.style.top=ROUND(_1f9.y)+"px";
_DOMElement.style.width=MAX(0,ROUND((_frame.size.width)))+"px";
_DOMElement.style.height=MAX(0,ROUND((_frame.size.height)))+"px";
var _1fa=0,_1fb=_subviews.length;
for(;_1fa<_1fb;++_1fa){
_DOMElement.appendChild(_subviews[_1fa]._DOMElement);
}
if(objj_msgSend(_1f8,"containsValueForKey:",_1ed)){
objj_msgSend(self,"setHidden:",objj_msgSend(_1f8,"decodeBoolForKey:",_1ed));
}else{
_isHidden=NO;
}
if(objj_msgSend(_1f8,"containsValueForKey:",_1ee)){
objj_msgSend(self,"setAlphaValue:",objj_msgSend(_1f8,"decodeIntForKey:",_1ee));
}else{
_opacity=1;
}
objj_msgSend(self,"setBackgroundColor:",objj_msgSend(_1f8,"decodeObjectForKey:",_1e9));
objj_msgSend(self,"setupViewFlags");
_theme=objj_msgSend(CPTheme,"themeForView:",self);
_themeClass=objj_msgSend(_1f8,"decodeObjectForKey:",_1f2);
_themeState=CPThemeState(objj_msgSend(_1f8,"decodeIntForKey:",_1f3));
_themeAttributes={};
var _1fc=objj_msgSend(self,"class"),_1fd=objj_msgSend(self,"themeClass"),_1fe=objj_msgSend(_1fc,"_themeAttributes"),_1fb=_1fe.length;
while(_1fb--){
var _1ff=_1fe[_1fb--];
_themeAttributes[_1ff]=CPThemeAttributeDecode(_1f8,_1ff,_1fe[_1fb],_theme,_1fd);
}
objj_msgSend(self,"setNeedsDisplay:",YES);
objj_msgSend(self,"setNeedsLayout");
}
...
}),new objj_method(sel_getUid("encodeWithCoder:"),function(self,_200,_201){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPView").super_class},"encodeWithCoder:",_201);
if(_tag!==-1){
objj_msgSend(_201,"encodeInt:forKey:",_tag,_1f1);
}
objj_msgSend(_201,"encodeRect:forKey:",_frame,_1eb);
objj_msgSend(_201,"encodeRect:forKey:",_bounds,_1ea);
if(_window!==nil){
objj_msgSend(_201,"encodeConditionalObject:forKey:",_window,_1f4);
}
...
if(_203.length>0){
objj_msgSend(_201,"encodeObject:forKey:",_203,_1ef);
}
if(_superview!==nil){
objj_msgSend(_201,"encodeConditionalObject:forKey:",_superview,_1f0);
}
if(_autoresizingMask!==CPViewNotSizable){
objj_msgSend(_201,"encodeInt:forKey:",_autoresizingMask,_1e7);
}
if(!_autoresizesSubviews){
objj_msgSend(_201,"encodeBool:forKey:",_autoresizesSubviews,_1e8);
}
if(_backgroundColor!==nil){
objj_msgSend(_201,"encodeObject:forKey:",_backgroundColor,_1e9);
}
if(_hitTests!==YES){
objj_msgSend(_201,"encodeBool:forKey:",_hitTests,_1ec);
}
if(_opacity!==1){
objj_msgSend(_201,"encodeFloat:forKey:",_opacity,_1ee);
}
if(_isHidden){
objj_msgSend(_201,"encodeBool:forKey:",_isHidden,_1ed);
}
var _204=objj_msgSend(self,"nextKeyView");
if(_204!==nil&&!objj_msgSend(_204,"isEqual:",self)){
objj_msgSend(_201,"encodeConditionalObject:forKey:",_204,_1f5);
}
var _205=objj_msgSend(self,"previousKeyView");
if(_205!==nil&&!objj_msgSend(_205,"isEqual:",self)){
objj_msgSend(_201,"encodeConditionalObject:forKey:",_205,_1f6);
}
objj_msgSend(_201,"encodeObject:forKey:",objj_msgSend(self,"themeClass"),_1f2);
objj_msgSend(_201,"encodeInt:forKey:",CPThemeStateName(_themeState),_1f3);
...
var _114=function(_209,_20a){
var _20b=CGAffineTransformMakeIdentity(),_20c=YES,_20d=nil,_20e=nil;
if(_209){
var view=_209;
while(view&&view!=_20a){
var _20f=view._frame;
_20b.tx+=(_20f.origin.x);
_20b.ty+=(_20f.origin.y);
...
_20c=NO;
var _20f=objj_msgSend(_20d,"frame");
_20b.tx+=(_20f.origin.x);
_20b.ty+=(_20f.origin.y);
}
}
...
if(!_20c){
var _20f=objj_msgSend(_20e,"frame");
_20b.tx-=(_20f.origin.x);
_20b.ty-=(_20f.origin.y);
}
return _20b;
...
p;9;CPColor.jt;13869;@STATIC;1.0;I;21;Foundation/CPObject.ji;9;CGColor.ji;17;CPCompatibility.ji;9;CPImage.jt;13775;
objj_executeFile("Foundation/CPObject.j",NO);
...
CPColorPatternIsVertical=YES,CPColorPatternIsHorizontal=NO;
...
if(_22){
_components=_24;
var _25=CPFeatureIsCompatible(CPCSSRGBAFeature)&&_components[3]!=1;
_cssString=(_25?"rgba(":"rgb(")+parseInt(_components[0]*255)+", "+parseInt(_components[1]*255)+", "+parseInt(_components[2]*255)+(_25?(", "+_components[3]):"")+")";
}
return _22;
}
}),new objj_method(sel_getUid("_initWithPatternImage:"),function(_26,_27,_28){
with(_26){
_26=objj_msgSendSuper({receiver:_26,super_class:objj_getClass("CPColor").super_class},"init");
if(_26){
_patternImage=_28;
...
}),new objj_method(sel_getUid("patternImage"),function(_29,_2a){
with(_29){
return _patternImage;
}
}),new objj_method(sel_getUid("alphaComponent"),function(_2b,_2c){
with(_2b){
return _components[3];
}
}),new objj_method(sel_getUid("blueComponent"),function(_2d,_2e){
with(_2d){
return _components[2];
}
}),new objj_method(sel_getUid("greenComponent"),function(_2f,_30){
with(_2f){
return _components[1];
}
}),new objj_method(sel_getUid("redComponent"),function(_31,_32){
with(_31){
return _components[0];
}
}),new objj_method(sel_getUid("components"),function(_33,_34){
with(_33){
return _components;
}
}),new objj_method(sel_getUid("colorWithAlphaComponent:"),function(_35,_36,_37){
with(_35){
var _38=_components.slice();
_38[_38.length-1]=_37;
return objj_msgSend(objj_msgSend(objj_msgSend(_35,"class"),"alloc"),"_initWithRGBA:",_38);
}
}),new objj_method(sel_getUid("hsbComponents"),function(_39,_3a){
with(_39){
var red=ROUND(_components[_1]*255),_3b=ROUND(_components[_2]*255),_3c=ROUND(_components[_3]*255);
var max=MAX(red,_3b,_3c),min=MIN(red,_3b,_3c),_3d=max-min;
var _3e=max/255,_3f=(max!=0)?_3d/max:0;
var hue;
if(_3f==0){
hue=0;
}else{
var rr=(max-red)/_3d,gr=(max-_3b)/_3d,br=(max-_3c)/_3d;
if(red==max){
hue=br-gr;
}else{
if(_3b==max){
...
return [ROUND(hue*360),ROUND(_3f*100),ROUND(_3e*100)];
}
}),new objj_method(sel_getUid("cssString"),function(_40,_41){
with(_40){
return _cssString;
}
}),new objj_method(sel_getUid("hexString"),function(_42,_43){
with(_42){
return _44(objj_msgSend(_42,"redComponent"),objj_msgSend(_42,"greenComponent"),objj_msgSend(_42,"blueComponent"));
}
...
if(!objj_msgSend(_47,"isKindOfClass:",CPColor)){
return NO;
}
if(_patternImage||objj_msgSend(_47,"patternImage")){
return objj_msgSend(_patternImage,"isEqual:",objj_msgSend(_47,"patternImage"));
}
return ROUND(objj_msgSend(_45,"redComponent")*255)==ROUND(objj_msgSend(_47,"redComponent")*255)&&ROUND(objj_msgSend(_45,"greenComponent")*255)==ROUND(objj_msgSend(_47,"greenComponent")*255)&&ROUND(objj_msgSend(_45,"blueComponent")*255)==ROUND(objj_msgSend(_47,"blueComponent")*255)&&objj_msgSend(_45,"alphaComponent")==objj_msgSend(_47,"alphaComponent");
}
}),new objj_method(sel_getUid("description"),function(_48,_49){
with(_48){
var _4a=objj_msgSendSuper({receiver:_48,super_class:objj_getClass("CPColor").super_class},"description"),_4b=objj_msgSend(_48,"patternImage");
if(!_4b){
return _4a+" "+objj_msgSend(_48,"cssString");
}
_4a+=" {\n";
if(objj_msgSend(_4b,"isThreePartImage")||objj_msgSend(_4b,"isNinePartImage")){
var _4c=objj_msgSend(_4b,"imageSlices");
if(objj_msgSend(_4b,"isThreePartImage")){
_4a+="    orientation: "+(objj_msgSend(_4b,"isVertical")?"vertical":"horizontal")+",\n";
}
_4a+="    patternImage ("+_4c.length+" part): [\n";
for(var i=0;i<_4c.length;++i){
var _4d=objj_msgSend(_4c[i],"description");
_4a+=_4d.replace(/^/mg,"        ")+",\n";
}
_4a=_4a.substr(0,_4a.length-2)+"\n    ]\n}";
}else{
_4a+=objj_msgSend(_4b,"description").replace(/^/mg,"    ")+"\n}";
}
return _4a;
}
})]);
class_addMethods(_1c,[new objj_method(sel_getUid("colorWithRed:green:blue:alpha:"),function(_4e,_4f,red,_50,_51,_52){
with(_4e){
return objj_msgSend(objj_msgSend(CPColor,"alloc"),"_initWithRGBA:",[red,_50,_51,_52]);
}
}),new objj_method(sel_getUid("colorWithCalibratedRed:green:blue:alpha:"),function(_53,_54,red,_55,_56,_57){
with(_53){
return objj_msgSend(_53,"colorWithRed:green:blue:alpha:",red,_55,_56,_57);
}
}),new objj_method(sel_getUid("colorWithWhite:alpha:"),function(_58,_59,_5a,_5b){
with(_58){
return objj_msgSend(objj_msgSend(CPColor,"alloc"),"_initWithRGBA:",[_5a,_5a,_5a,_5b]);
}
}),new objj_method(sel_getUid("colorWithCalibratedWhite:alpha:"),function(_5c,_5d,_5e,_5f){
with(_5c){
return objj_msgSend(_5c,"colorWithWhite:alpha:",_5e,_5f);
}
}),new objj_method(sel_getUid("colorWithHue:saturation:brightness:"),function(_60,_61,hue,_62,_63){
with(_60){
return objj_msgSend(_60,"colorWithHue:saturation:brightness:alpha:",hue,_62,_63,1);
}
}),new objj_method(sel_getUid("colorWithHue:saturation:brightness:alpha:"),function(_64,_65,hue,_66,_67,_68){
with(_64){
if(_66===0){
return objj_msgSend(CPColor,"colorWithCalibratedWhite:alpha:",_67/100,_68);
}
var f=hue%60,p=(_67*(100-_66))/10000,q=(_67*(6000-_66*f))/600000,t=(_67*(6000-_66*(60-f)))/600000,b=_67/100;
switch(FLOOR(hue/60)){
case 0:
return objj_msgSend(CPColor,"colorWithCalibratedRed:green:blue:alpha:",b,t,p,_68);
case 1:
return objj_msgSend(CPColor,"colorWithCalibratedRed:green:blue:alpha:",q,b,p,_68);
case 2:
return objj_msgSend(CPColor,"colorWithCalibratedRed:green:blue:alpha:",p,b,t,_68);
case 3:
return objj_msgSend(CPColor,"colorWithCalibratedRed:green:blue:alpha:",p,q,b,_68);
case 4:
return objj_msgSend(CPColor,"colorWithCalibratedRed:green:blue:alpha:",t,p,b,_68);
case 5:
return objj_msgSend(CPColor,"colorWithCalibratedRed:green:blue:alpha:",b,p,q,_68);
}
}
}),new objj_method(sel_getUid("colorWithHexString:"),function(_69,_6a,hex){
with(_69){
var _6b=_6c(hex);
return _6b?objj_msgSend(objj_msgSend(CPColor,"alloc"),"_initWithRGBA:",_6b):null;
}
}),new objj_method(sel_getUid("blackColor"),function(_6d,_6e){
with(_6d){
if(!_8){
...
}),new objj_method(sel_getUid("blueColor"),function(_6f,_70){
with(_6f){
if(!_b){
...
}),new objj_method(sel_getUid("darkGrayColor"),function(_71,_72){
with(_71){
if(!_f){
...
}),new objj_method(sel_getUid("grayColor"),function(_73,_74){
with(_73){
if(!_d){
...
}),new objj_method(sel_getUid("greenColor"),function(_75,_76){
with(_75){
if(!_a){
...
}),new objj_method(sel_getUid("lightGrayColor"),function(_77,_78){
with(_77){
if(!_e){
...
}),new objj_method(sel_getUid("redColor"),function(_79,_7a){
with(_79){
if(!_9){
...
}),new objj_method(sel_getUid("whiteColor"),function(_7b,_7c){
with(_7b){
if(!_10){
...
}),new objj_method(sel_getUid("yellowColor"),function(_7d,_7e){
with(_7d){
if(!_c){
...
}),new objj_method(sel_getUid("brownColor"),function(_7f,_80){
with(_7f){
if(!_11){
...
}),new objj_method(sel_getUid("cyanColor"),function(_81,_82){
with(_81){
if(!_12){
...
}),new objj_method(sel_getUid("magentaColor"),function(_83,_84){
with(_83){
if(!_13){
...
}),new objj_method(sel_getUid("orangeColor"),function(_85,_86){
with(_85){
if(!_14){
...
}),new objj_method(sel_getUid("purpleColor"),function(_87,_88){
with(_87){
if(!_15){
...
}),new objj_method(sel_getUid("shadowColor"),function(_89,_8a){
with(_89){
if(!_16){
...
}),new objj_method(sel_getUid("clearColor"),function(_8b,_8c){
with(_8b){
if(!_17){
_17=objj_msgSend(_8b,"colorWithCalibratedWhite:alpha:",0,0);
}
return _17;
}
}),new objj_method(sel_getUid("alternateSelectedControlColor"),function(_8d,_8e){
with(_8d){
return objj_msgSend(objj_msgSend(CPColor,"alloc"),"_initWithRGBA:",[0.22,0.46,0.84,1]);
}
}),new objj_method(sel_getUid("secondarySelectedControlColor"),function(_8f,_90){
with(_8f){
return objj_msgSend(objj_msgSend(CPColor,"alloc"),"_initWithRGBA:",[0.83,0.83,0.83,1]);
}
}),new objj_method(sel_getUid("colorWithPatternImage:"),function(_91,_92,_93){
with(_91){
return objj_msgSend(objj_msgSend(CPColor,"alloc"),"_initWithPatternImage:",_93);
}
}),new objj_method(sel_getUid("colorWithCSSString:"),function(_94,_95,_96){
with(_94){
return objj_msgSend(objj_msgSend(CPColor,"alloc"),"_initWithCSSString:",_96);
}
})]);
...
var _1c=_1b.isa;
class_addMethods(_1b,[new objj_method(sel_getUid("set"),function(_97,_98){
with(_97){
objj_msgSend(_97,"setFill");
objj_msgSend(_97,"setStroke");
}
}),new objj_method(sel_getUid("setFill"),function(_99,_9a){
with(_99){
var ctx=objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort");
CGContextSetFillColor(ctx,_99);
}
}),new objj_method(sel_getUid("setStroke"),function(_9b,_9c){
with(_9b){
var ctx=objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort");
CGContextSetStrokeColor(ctx,_9b);
}
})]);
var _1b=objj_getClass("CPColor");
if(!_1b){
...
var _1c=_1b.isa;
class_addMethods(_1c,[new objj_method(sel_getUid("randomColor"),function(_9d,_9e){
with(_9d){
return objj_msgSend(CPColor,"colorWithRed:green:blue:alpha:",RAND(),RAND(),RAND(),1);
}
})]);
var _9f="CPColorComponentsKey",_a0="CPColorPatternImageKey";
var _1b=objj_getClass("CPColor");
if(!_1b){
throw new SyntaxError("*** Could not find definition for class \"CPColor\"");
}
var _1c=_1b.isa;
class_addMethods(_1b,[new objj_method(sel_getUid("initWithCoder:"),function(_a1,_a2,_a3){
with(_a1){
if(objj_msgSend(_a3,"containsValueForKey:",_a0)){
return objj_msgSend(_a1,"_initWithPatternImage:",objj_msgSend(_a3,"decodeObjectForKey:",_a0));
}
return objj_msgSend(_a1,"_initWithRGBA:",objj_msgSend(_a3,"decodeObjectForKey:",_9f));
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_a4,_a5,_a6){
with(_a4){
if(_patternImage){
objj_msgSend(_a6,"encodeObject:forKey:",_patternImage,_a0);
}else{
objj_msgSend(_a6,"encodeObject:forKey:",_components,_9f);
}
}
})]);
var _a7="0123456789ABCDEF";
var _6c=function(hex){
if(hex.length==3){
...
if(_a7.indexOf(hex.charAt(i))==-1){
return null;
}
}
var red=(_a7.indexOf(hex.charAt(0))*16+_a7.indexOf(hex.charAt(1)))/255,_a8=(_a7.indexOf(hex.charAt(2))*16+_a7.indexOf(hex.charAt(3)))/255,_a9=(_a7.indexOf(hex.charAt(4))*16+_a7.indexOf(hex.charAt(5)))/255;
return [red,_a8,_a9,1];
};
var _44=function(r,g,b){
return _aa(r)+_aa(g)+_aa(b);
};
var _aa=function(n){
if(!n||isNaN(n)){
return "00";
...
return _a7.charAt((n-n%16)/16)+_a7.charAt(n%16);
};
...
p;9;CPEvent.jt;11971;@STATIC;1.0;I;21;Foundation/CPObject.ji;8;CPText.jt;11913;
objj_executeFile("Foundation/CPObject.j",NO);
objj_executeFile("CPText.j",YES);
CPLeftMouseDown=1;
CPLeftMouseUp=2;
...
var _58=objj_msgSend(objj_msgSend(_window,"firstResponder"),"isKindOfClass:",objj_msgSend(CPTextField,"class"));
for(var i=0;i<_57;i++){
var c=_characters.charAt(i);
if((c>=CPUpArrowFunctionKey&&c<=CPModeSwitchFunctionKey)||c===CPEnterCharacter||c===CPNewlineCharacter||c===CPCarriageReturnCharacter||c===CPEscapeFunctionKey||(!_58&&(c===CPSpaceFunctionKey||c===CPDeleteCharacter||c===CPBackspaceCharacter))){
return YES;
}
}
return NO;
...
class_addMethods(_5,[new objj_method(sel_getUid("keyEventWithType:location:modifierFlags:timestamp:windowNumber:context:characters:charactersIgnoringModifiers:isARepeat:keyCode:"),function(_59,_5a,_5b,_5c,_5d,_5e,_5f,_60,_61,_62,_63,_64){
with(_59){
return objj_msgSend(objj_msgSend(_59,"alloc"),"_initKeyEventWithType:location:modifierFlags:timestamp:windowNumber:context:characters:charactersIgnoringModifiers:isARepeat:keyCode:",_5b,_5c,_5d,_5e,_5f,_60,_61,_62,_63,_64);
}
}),new objj_method(sel_getUid("mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:"),function(_65,_66,_67,_68,_69,_6a,_6b,_6c,_6d,_6e,_6f){
with(_65){
return objj_msgSend(objj_msgSend(_65,"alloc"),"_initMouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:",_67,_68,_69,_6a,_6b,_6c,_6d,_6e,_6f);
}
}),new objj_method(sel_getUid("otherEventWithType:location:modifierFlags:timestamp:windowNumber:context:subtype:data1:data2:"),function(_70,_71,_72,_73,_74,_75,_76,_77,_78,_79,_7a){
with(_70){
return objj_msgSend(objj_msgSend(_70,"alloc"),"_initOtherEventWithType:location:modifierFlags:timestamp:windowNumber:context:subtype:data1:data2:",_72,_73,_74,_75,_76,_77,_78,_79,_7a);
}
}),new objj_method(sel_getUid("mouseLocation"),function(_7b,_7c){
with(_7b){
var _7d=objj_msgSend(CPApp,"currentEvent"),_7e=objj_msgSend(_7d,"window");
if(_7e){
return objj_msgSend(_7e,"convertBaseToGlobal:",objj_msgSend(_7d,"locationInWindow"));
}
return objj_msgSend(_7d,"locationInWindow");
}
}),new objj_method(sel_getUid("startPeriodicEventsAfterDelay:withPeriod:"),function(_7f,_80,_81,_82){
with(_7f){
_1=_82;
_2=window.setTimeout(function(){
_2=window.setInterval(_CPEventFirePeriodEvent,_82*1000);
},_81*1000);
}
}),new objj_method(sel_getUid("stopPeriodicEvents"),function(_83,_84){
with(_83){
if(_2===nil){
return;
}
...
var _85=objj_msgSend(CPEvent,"class");
_CPEventFromNativeMouseEvent=function(_86,_87,_88,_89,_8a,_8b,_8c,_8d,_8e,_8f){
_86.isa=_85;
_86._type=_87;
_86._location=_88;
_86._modifierFlags=_89;
_86._timestamp=_8a;
_86._windowNumber=_8b;
_86._window=nil;
_86._context=_8c;
_86._eventNumber=_8d;
_86._clickCount=_8e;
_86._pressure=_8f;
return _86;
};
...
p;15;CPApplication.jt;30686;@STATIC;1.0;I;21;Foundation/CPBundle.ji;17;CPCompatibility.ji;9;CPEvent.ji;8;CPMenu.ji;13;CPResponder.ji;22;CPDocumentController.ji;14;CPThemeBlend.ji;14;CPCibLoading.ji;12;CPPlatform.jt;30493;
objj_executeFile("Foundation/CPBundle.j",NO);
objj_executeFile("CPCompatibility.j",YES);
objj_executeFile("CPEvent.j",YES);
objj_executeFile("CPMenu.j",YES);
...
}),new objj_method(sel_getUid("themeBlend"),function(_ea,_eb){
with(_ea){
return (_themeBlends.length>0?_themeBlends[0]:nil);
}
}),new objj_method(sel_getUid("setThemeBlend:"),function(_ec,_ed,_ee){
with(_ec){
_themeBlends[0]=_ee;
}
})]);
class_addMethods(_4,[new objj_method(sel_getUid("sharedApplication"),function(_ef,_f0){
with(_ef){
if(!CPApp){
...
}),new objj_method(sel_getUid("defaultThemeName"),function(_f1,_f2){
with(_f1){
return (objj_msgSend(objj_msgSend(CPBundle,"mainBundle"),"objectForInfoDictionaryKey:","CPDefaultTheme")||"Aristo");
}
})]);
var _64=function(_f3,_f4){
return {_window:_f3,_state:CPRunContinuesResponse,_previous:nil};
};
var _b3=function(_f5,_f6){
return {_mask:_f5,_callback:_f6};
};
_CPRunModalLoop=function(_f7){
objj_msgSend(CPApp,"setCallback:forNextEventMatchingMask:untilDate:inMode:dequeue:",_CPRunModalLoop,CPAnyEventMask,nil,0,NO);
var _f8=objj_msgSend(_f7,"window"),_f9=CPApp._currentSession;
if(_f8==_f9._window||objj_msgSend(_f8,"worksWhenModal")){
objj_msgSend(_f8,"sendEvent:",_f7);
}
};
CPApplicationMain=function(_fa,_fb){
if(window.parent!==window&&typeof window.parent._childAppIsStarting==="function"){
window.parent._childAppIsStarting(window);
}
var _fc=objj_msgSend(CPBundle,"mainBundle"),_fd=objj_msgSend(_fc,"principalClass");
if(!_fd){
_fd=objj_msgSend(CPApplication,"class");
}
objj_msgSend(_fd,"sharedApplication");
if(objj_msgSend(_fa,"containsObject:","debug")){
CPLogRegister(CPLogPopup);
}
CPApp._args=_fa;
CPApp._namedArgs=_fb;
objj_msgSend(_CPAppBootstrapper,"performActions");
};
var _fe=nil,_ff=[];
var _3=objj_allocateClassPair(CPObject,"_CPAppBootstrapper"),_4=_3.isa;
objj_registerClassPair(_3);
class_addMethods(_4,[new objj_method(sel_getUid("actions"),function(self,_100){
with(self){
return [sel_getUid("bootstrapPlatform"),sel_getUid("loadThemes"),sel_getUid("loadMainCibFile")];
}
}),new objj_method(sel_getUid("performActions"),function(self,_101){
with(self){
if(!_fe){
_fe=objj_msgSend(self,"actions");
}
while(_fe.length){
var _102=_fe.shift();
if(objj_msgSend(self,_102)){
return;
}
}
objj_msgSend(CPApp,"run");
}
}),new objj_method(sel_getUid("bootstrapPlatform"),function(self,_103){
with(self){
return objj_msgSend(CPPlatform,"bootstrap");
}
}),new objj_method(sel_getUid("loadThemes"),function(self,_104){
with(self){
_ff.push(objj_msgSend(CPApplication,"defaultThemeName"));
var _105=(objj_msgSend(objj_msgSend(CPBundle,"mainBundle"),"objectForInfoDictionaryKey:","CPAuxiliaryThemes")||[]);
_ff=_ff.concat(_105);
objj_msgSend(self,"loadNextTheme");
return YES;
}
}),new objj_method(sel_getUid("loadNextTheme"),function(self,_106){
with(self){
var _107=_ff.shift();
if(_107==="Aristo"){
themeURL=objj_msgSend(objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPApplication,"class")),"pathForResource:",_107+".blend");
}else{
themeURL=objj_msgSend(objj_msgSend(CPBundle,"mainBundle"),"pathForResource:",_107+".blend");
}
var _108=objj_msgSend(objj_msgSend(CPThemeBlend,"alloc"),"initWithContentsOfURL:",themeURL);
objj_msgSend(_108,"loadWithDelegate:",self);
return YES;
}
}),new objj_method(sel_getUid("blendDidFinishLoading:"),function(self,_109,_10a){
with(self){
var _10b=objj_msgSend(CPApp,"themeBlends");
objj_msgSend(_10b,"addObject:",_10a);
if(objj_msgSend(_10b,"count")===1){
...
}),new objj_method(sel_getUid("loadMainCibFile"),function(self,_10c){
with(self){
var _10d=objj_msgSend(CPBundle,"mainBundle"),_10e=objj_msgSend(_10d,"objectForInfoDictionaryKey:",_1)||objj_msgSend(_10d,"objectForInfoDictionaryKey:",_2);
if(_10e){
objj_msgSend(_10d,"loadCibFile:externalNameTable:loadDelegate:",_10e,objj_msgSend(CPDictionary,"dictionaryWithObject:forKey:",CPApp,CPCibOwner),self);
return YES;
}else{
...
}),new objj_method(sel_getUid("loadCiblessBrowserMainMenu"),function(self,_10f){
with(self){
var _110=objj_msgSend(objj_msgSend(CPMenu,"alloc"),"initWithTitle:","MainMenu");
objj_msgSend(_110,"setAutoenablesItems:",NO);
var _111=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPApplication,"class")),_112=objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","New",sel_getUid("newDocument:"),"n");
objj_msgSend(_112,"setImage:",objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_111,"pathForResource:","CPApplication/New.png"),CGSizeMake(16,16)));
objj_msgSend(_112,"setAlternateImage:",objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_111,"pathForResource:","CPApplication/NewHighlighted.png"),CGSizeMake(16,16)));
objj_msgSend(_110,"addItem:",_112);
var _113=objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Open",sel_getUid("openDocument:"),"o");
objj_msgSend(_113,"setImage:",objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_111,"pathForResource:","CPApplication/Open.png"),CGSizeMake(16,16)));
objj_msgSend(_113,"setAlternateImage:",objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_111,"pathForResource:","CPApplication/OpenHighlighted.png"),CGSizeMake(16,16)));
objj_msgSend(_110,"addItem:",_113);
var _114=objj_msgSend(objj_msgSend(CPMenu,"alloc"),"initWithTitle:","Save"),_115=objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Save",sel_getUid("saveDocument:"),nil);
objj_msgSend(_115,"setImage:",objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_111,"pathForResource:","CPApplication/Save.png"),CGSizeMake(16,16)));
objj_msgSend(_115,"setAlternateImage:",objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_111,"pathForResource:","CPApplication/SaveHighlighted.png"),CGSizeMake(16,16)));
objj_msgSend(_114,"addItem:",objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Save",sel_getUid("saveDocument:"),"s"));
objj_msgSend(_114,"addItem:",objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Save As",sel_getUid("saveDocumentAs:"),nil));
objj_msgSend(_115,"setSubmenu:",_114);
objj_msgSend(_110,"addItem:",_115);
var _116=objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Edit",nil,nil),_117=objj_msgSend(objj_msgSend(CPMenu,"alloc"),"initWithTitle:","Edit"),_118=objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Undo",sel_getUid("undo:"),CPUndoKeyEquivalent),_119=objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Redo",sel_getUid("redo:"),CPRedoKeyEquivalent);
objj_msgSend(_118,"setKeyEquivalentModifierMask:",CPUndoKeyEquivalentModifierMask);
objj_msgSend(_119,"setKeyEquivalentModifierMask:",CPRedoKeyEquivalentModifierMask);
objj_msgSend(_117,"addItem:",_118);
objj_msgSend(_117,"addItem:",_119);
objj_msgSend(_117,"addItem:",objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Cut",sel_getUid("cut:"),"x")),objj_msgSend(_117,"addItem:",objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Copy",sel_getUid("copy:"),"c")),objj_msgSend(_117,"addItem:",objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:","Paste",sel_getUid("paste:"),"v"));
objj_msgSend(_116,"setSubmenu:",_117);
objj_msgSend(_116,"setHidden:",YES);
objj_msgSend(_110,"addItem:",_116);
objj_msgSend(_110,"addItem:",objj_msgSend(CPMenuItem,"separatorItem"));
objj_msgSend(CPApp,"setMainMenu:",_110);
}
}),new objj_method(sel_getUid("cibDidFinishLoading:"),function(self,_11a,aCib){
with(self){
objj_msgSend(self,"performActions");
}
}),new objj_method(sel_getUid("cibDidFailToLoad:"),function(self,_11b,aCib){
with(self){
throw new Error("Could not load main cib file (Did you forget to nib2cib it?).");
}
}),new objj_method(sel_getUid("reset"),function(self,_11c){
with(self){
_fe=nil;
}
})]);
p;8;CPMenu.jt;26085;@STATIC;1.0;I;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPString.ji;16;_CPMenuManager.ji;15;CPApplication.ji;12;CPClipView.ji;12;CPMenuItem.ji;9;CPPanel.ji;18;_CPMenuBarWindow.ji;15;_CPMenuWindow.jt;25815;
objj_executeFile("Foundation/CPArray.j",NO);
...
while(obj=objj_msgSend(_53,"nextObject")){
...
while(obj=objj_msgSend(_5a,"nextObject")){
...
objj_msgSend(_CPDisplayServer,"run");
p;13;CPAnimation.jt;5543;@STATIC;1.0;I;21;Foundation/CPObject.jI;20;Foundation/CPTimer.ji;23;CAMediaTimingFunction.jt;5445;
objj_executeFile("Foundation/CPObject.j",NO);
...
p;22;CPPlatformWindow+DOM.jt;33541;@STATIC;1.0;I;21;Foundation/CPObject.jI;22;Foundation/CPRunLoop.ji;9;CPEvent.ji;8;CPText.ji;17;CPCompatibility.ji;18;CPDOMWindowLayer.ji;12;CPPlatform.ji;18;CPPlatformWindow.ji;26;CPPlatformWindow+DOMKeys.jt;33327;
objj_executeFile("Foundation/CPObject.j",NO);
objj_executeFile("Foundation/CPRunLoop.j",NO);
objj_executeFile("CPEvent.j",YES);
objj_executeFile("CPText.j",YES);
...
p;9;CPImage.jt;10544;@STATIC;1.0;I;21;Foundation/CPBundle.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPObject.jI;22;Foundation/CPRunLoop.jI;21;Foundation/CPString.ji;12;CPGeometry.jt;10364;
objj_executeFile("Foundation/CPBundle.j",NO);
objj_executeFile("Foundation/CPNotificationCenter.j",NO);
objj_executeFile("Foundation/CPObject.j",NO);
objj_executeFile("Foundation/CPRunLoop.j",NO);
...
}),new objj_method(sel_getUid("filename"),function(_18,_19){
with(_18){
return _filename;
}
}),new objj_method(sel_getUid("setSize:"),function(_1a,_1b,_1c){
with(_1a){
_size=CGSizeMakeCopy(_1c);
}
}),new objj_method(sel_getUid("size"),function(_1d,_1e){
with(_1d){
return _size;
}
}),new objj_method(sel_getUid("setName:"),function(_1f,_20,_21){
with(_1f){
if(_name===_21){
return YES;
}
...
}),new objj_method(sel_getUid("name"),function(_22,_23){
with(_22){
return _name;
}
}),new objj_method(sel_getUid("setDelegate:"),function(_24,_25,_26){
with(_24){
_delegate=_26;
}
}),new objj_method(sel_getUid("delegate"),function(_27,_28){
with(_27){
return _delegate;
}
...
}),new objj_method(sel_getUid("load"),function(_2b,_2c){
with(_2b){
...
objj_msgSend(_2b,"_imageDidLoad");
},0);
}else{
objj_msgSend(_2b,"_imageDidLoad");
objj_msgSend(objj_msgSend(CPRunLoop,"currentRunLoop"),"limitDateForMode:",CPDefaultRunLoopMode);
}
objj_msgSend(_2b,"_derefFromImage");
};
_image.onerror=function(){
if(_2d){
window.setTimeout(function(){
objj_msgSend(_2b,"_imageDidError");
},0);
}else{
objj_msgSend(_2b,"_imageDidError");
objj_msgSend(objj_msgSend(CPRunLoop,"currentRunLoop"),"limitDateForMode:",CPDefaultRunLoopMode);
...
if(_2d){
window.setTimeout(function(){
objj_msgSend(_2b,"_imageDidAbort");
},0);
}else{
objj_msgSend(_2b,"_imageDidAbort");
objj_msgSend(objj_msgSend(CPRunLoop,"currentRunLoop"),"limitDateForMode:",CPDefaultRunLoopMode);
...
}),new objj_method(sel_getUid("isThreePartImage"),function(_2e,_2f){
with(_2e){
return NO;
}
}),new objj_method(sel_getUid("isNinePartImage"),function(_30,_31){
with(_30){
return NO;
}
}),new objj_method(sel_getUid("description"),function(_32,_33){
with(_32){
var _34=objj_msgSend(_32,"filename"),_35=objj_msgSend(_32,"size");
if(_34.indexOf("data:")===0){
var _36=_34.indexOf(",");
if(_36>0){
_34=objj_msgSend(CPString,"stringWithFormat:","%s,%s...%s",_34.substr(0,_36),_34.substr(_36+1,10),_34.substr(_34.length-10));
}else{
_34="data:<unknown type>";
}
}
return objj_msgSend(CPString,"stringWithFormat:",_3,objj_msgSendSuper({receiver:_32,super_class:objj_getClass("CPImage").super_class},"description"),_34,_35.width,_35.height);
}
}),new objj_method(sel_getUid("_derefFromImage"),function(_37,_38){
with(_37){
_image.onload=null;
_image.onerror=null;
_image.onabort=null;
}
}),new objj_method(sel_getUid("_imageDidLoad"),function(_39,_3a){
with(_39){
_loadStatus=CPImageLoadStatusCompleted;
if(!_size||(_size.width==-1&&_size.height==-1)){
_size=CGSizeMake(_image.width,_image.height);
}
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",CPImageDidLoadNotification,_39);
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("imageDidLoad:"))){
objj_msgSend(_delegate,"imageDidLoad:",_39);
}
}
}),new objj_method(sel_getUid("_imageDidError"),function(_3b,_3c){
with(_3b){
_loadStatus=CPImageLoadStatusReadError;
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("imageDidError:"))){
objj_msgSend(_delegate,"imageDidError:",_3b);
}
}
}),new objj_method(sel_getUid("_imageDidAbort"),function(_3d,_3e){
with(_3d){
_loadStatus=CPImageLoadStatusCancelled;
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("imageDidAbort:"))){
objj_msgSend(_delegate,"imageDidAbort:",_3d);
}
}
})]);
class_addMethods(_a,[new objj_method(sel_getUid("imageNamed:"),function(_3f,_40,_41){
with(_3f){
var _42=_1[_41];
if(_42){
return _42;
...
if(!_43.isa){
_43=CPAppKitImage("CPImage/"+_41+".png",_43);
objj_msgSend(_43,"setName:",_41);
_2[_41]=_43;
}
return _43;
}
...
var _a=_9.isa;
class_addMethods(_9,[new objj_method(sel_getUid("initWithCoder:"),function(_44,_45,_46){
with(_44){
return objj_msgSend(_44,"initWithContentsOfFile:size:",objj_msgSend(_46,"decodeObjectForKey:","CPFilename"),objj_msgSend(_46,"decodeSizeForKey:","CPSize"));
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_47,_48,_49){
with(_47){
objj_msgSend(_49,"encodeObject:forKey:",_filename,"CPFilename");
objj_msgSend(_49,"encodeSize:forKey:",_size,"CPSize");
}
})]);
...
objj_registerClassPair(_9);
class_addMethods(_9,[new objj_method(sel_getUid("initWithImageSlices:isVertical:"),function(_4a,_4b,_4c,_4d){
with(_4a){
_4a=objj_msgSendSuper({receiver:_4a,super_class:objj_getClass("CPThreePartImage").super_class},"init");
if(_4a){
_imageSlices=_4c;
_isVertical=_4d;
}
...
}),new objj_method(sel_getUid("isVertical"),function(_52,_53){
with(_52){
return _isVertical;
}
...
var _58="CPThreePartImageImageSlicesKey",_59="CPThreePartImageIsVerticalKey";
var _9=objj_getClass("CPThreePartImage");
if(!_9){
throw new SyntaxError("*** Could not find definition for class \"CPThreePartImage\"");
}
var _a=_9.isa;
class_addMethods(_9,[new objj_method(sel_getUid("initWithCoder:"),function(_5a,_5b,_5c){
with(_5a){
_5a=objj_msgSendSuper({receiver:_5a,super_class:objj_getClass("CPThreePartImage").super_class},"init");
if(_5a){
_imageSlices=objj_msgSend(_5c,"decodeObjectForKey:",_58);
_isVertical=objj_msgSend(_5c,"decodeBoolForKey:",_59);
}
return _5a;
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_5d,_5e,_5f){
with(_5d){
objj_msgSend(_5f,"encodeObject:forKey:",_imageSlices,_58);
...
objj_registerClassPair(_9);
class_addMethods(_9,[new objj_method(sel_getUid("initWithImageSlices:"),function(_60,_61,_62){
with(_60){
_60=objj_msgSendSuper({receiver:_60,super_class:objj_getClass("CPNinePartImage").super_class},"init");
if(_60){
_imageSlices=_62;
}
return _60;
}
}),new objj_method(sel_getUid("filename"),function(_63,_64){
with(_63){
return "";
}
}),new objj_method(sel_getUid("imageSlices"),function(_65,_66){
with(_65){
return _imageSlices;
}
}),new objj_method(sel_getUid("isThreePartImage"),function(_67,_68){
with(_67){
return NO;
}
}),new objj_method(sel_getUid("isNinePartImage"),function(_69,_6a){
with(_69){
return YES;
}
})]);
var _6b="CPNinePartImageImageSlicesKey";
var _9=objj_getClass("CPNinePartImage");
if(!_9){
throw new SyntaxError("*** Could not find definition for class \"CPNinePartImage\"");
}
var _a=_9.isa;
class_addMethods(_9,[new objj_method(sel_getUid("initWithCoder:"),function(_6c,_6d,_6e){
with(_6c){
_6c=objj_msgSendSuper({receiver:_6c,super_class:objj_getClass("CPNinePartImage").super_class},"init");
if(_6c){
_imageSlices=objj_msgSend(_6e,"decodeObjectForKey:",_6b);
}
return _6c;
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_6f,_70,_71){
with(_6f){
objj_msgSend(_71,"encodeObject:forKey:",_imageSlices,_6b);
}
})]);
...
p;13;CPTextField.jt;36044;@STATIC;1.0;i;11;CPControl.ji;17;CPStringDrawing.ji;17;CPCompatibility.ji;21;_CPImageAndTextView.jt;35938;
objj_executeFile("CPControl.j",YES);
...
var _4f=objj_msgSend(_4d,"_inputElement"),_50="";
if(objj_msgSend(_4d,"_valueIsValid:",_4f.value)===NO){
...
}),new objj_method(sel_getUid("_valueIsValid:"),function(_51,_52,_53){
with(_51){
var _54="";
if(objj_msgSend(_51,"_setStringValue:isNewValue:errorDescription:",_53,NO,function(_55){
if(arguments.length){
return _54=_55;
}
return _54;
...
_56=objj_msgSend(_delegate,"control:didFailToFormatString:errorDescription:",_51,objj_msgSend(_51,"_inputElement"),_54);
}
if(_56===NO){
return NO;
}
...
}),new objj_method(sel_getUid("needsPanelToBecomeKey"),function(_57,_58){
with(_57){
return YES;
}
}),new objj_method(sel_getUid("mouseDown:"),function(_59,_5a,_5b){
with(_59){
if(objj_msgSend(_59,"isEditable")&&objj_msgSend(_59,"isEnabled")){
_willBecomeFirstResponderByClick=YES;
objj_msgSend(objj_msgSend(_59,"window"),"makeFirstResponder:",_59);
}else{
if(objj_msgSend(_59,"isSelectable")){
if(document.attachEvent){
_9=objj_msgSend(objj_msgSend(_59,"window"),"platformWindow")._DOMBodyElement.onselectstart;
_a=objj_msgSend(objj_msgSend(_59,"window"),"platformWindow")._DOMBodyElement.ondrag;
objj_msgSend(objj_msgSend(_59,"window"),"platformWindow")._DOMBodyElement.ondrag=function(){
};
objj_msgSend(objj_msgSend(_59,"window"),"platformWindow")._DOMBodyElement.onselectstart=function(){
};
}
return objj_msgSend(objj_msgSend(objj_msgSend(_5b,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",YES);
}else{
return objj_msgSend(objj_msgSend(_59,"nextResponder"),"mouseDown:",_5b);
}
}
}
}),new objj_method(sel_getUid("mouseUp:"),function(_5c,_5d,_5e){
with(_5c){
if(!objj_msgSend(_5c,"isSelectable")&&(!objj_msgSend(_5c,"isEditable")||!objj_msgSend(_5c,"isEnabled"))){
objj_msgSend(objj_msgSend(_5c,"nextResponder"),"mouseUp:",_5e);
}else{
if(objj_msgSend(_5c,"isSelectable")){
if(document.attachEvent){
objj_msgSend(objj_msgSend(_5c,"window"),"platformWindow")._DOMBodyElement.ondrag=_a;
objj_msgSend(objj_msgSend(_5c,"window"),"platformWindow")._DOMBodyElement.onselectstart=_9;
_9=nil;
_a=nil;
}
return objj_msgSend(objj_msgSend(objj_msgSend(_5e,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",YES);
}
}
}
}),new objj_method(sel_getUid("mouseDragged:"),function(_5f,_60,_61){
with(_5f){
if(!objj_msgSend(_5f,"isSelectable")&&(!objj_msgSend(_5f,"isEditable")||!objj_msgSend(_5f,"isEnabled"))){
objj_msgSend(objj_msgSend(_5f,"nextResponder"),"mouseDragged:",_61);
}else{
if(objj_msgSend(_5f,"isSelectable")){
return objj_msgSend(objj_msgSend(objj_msgSend(_61,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",YES);
}
}
}
}),new objj_method(sel_getUid("keyUp:"),function(_62,_63,_64){
with(_62){
var _65=objj_msgSend(_62,"_inputElement").value;
if(_65!==_stringValue){
objj_msgSend(_62,"_setStringValue:",_65);
if(!_isEditing){
_isEditing=YES;
objj_msgSend(_62,"textDidBeginEditing:",objj_msgSend(CPNotification,"notificationWithName:object:userInfo:",CPControlTextDidBeginEditingNotification,_62,nil));
}
objj_msgSend(_62,"textDidChange:",objj_msgSend(CPNotification,"notificationWithName:object:userInfo:",CPControlTextDidChangeNotification,_62,nil));
}
objj_msgSend(objj_msgSend(objj_msgSend(_62,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",YES);
}
}),new objj_method(sel_getUid("keyDown:"),function(_66,_67,_68){
with(_66){
objj_msgSend(objj_msgSend(objj_msgSend(_66,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",YES);
objj_msgSend(_66,"interpretKeyEvents:",[_68]);
objj_msgSend(objj_msgSend(CPRunLoop,"currentRunLoop"),"limitDateForMode:",CPDefaultRunLoopMode);
}
}),new objj_method(sel_getUid("doCommandBySelector:"),function(_69,_6a,_6b){
with(_69){
if(objj_msgSend(_69,"respondsToSelector:",_6b)){
objj_msgSend(_69,"performSelector:",_6b);
}
}
}),new objj_method(sel_getUid("insertNewline:"),function(_6c,_6d,_6e){
with(_6c){
if(objj_msgSend(_6c,"_valueIsValid:",_stringValue)){
if(!objj_msgSend(_6c,"action")||objj_msgSend(_6c,"sendAction:to:",objj_msgSend(_6c,"action"),objj_msgSend(_6c,"target"))){
if(_isEditing){
_isEditing=NO;
objj_msgSend(_6c,"textDidEndEditing:",objj_msgSend(CPNotification,"notificationWithName:object:userInfo:",CPControlTextDidEndEditingNotification,_6c,nil));
}
objj_msgSend(_6c,"selectAll:",nil);
}
}
objj_msgSend(objj_msgSend(objj_msgSend(_6c,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",NO);
}
}),new objj_method(sel_getUid("insertNewlineIgnoringFieldEditor:"),function(_6f,_70,_71){
with(_6f){
objj_msgSend(_6f,"_insertCharacterIgnoringFieldEditor:",CPNewlineCharacter);
}
}),new objj_method(sel_getUid("insertTabIgnoringFieldEditor:"),function(_72,_73,_74){
with(_72){
objj_msgSend(_72,"_insertCharacterIgnoringFieldEditor:",CPTabCharacter);
}
}),new objj_method(sel_getUid("_insertCharacterIgnoringFieldEditor:"),function(_75,_76,_77){
with(_75){
var _78=_stringValue,_79=objj_msgSend(_75,"selectedRange"),_7a=objj_msgSend(_75,"_inputElement");
_7a.value=objj_msgSend(_7a.value,"stringByReplacingCharactersInRange:withString:",objj_msgSend(_75,"selectedRange"),_77);
objj_msgSend(_75,"_setStringValue:",_7a.value);
if(_78!==_stringValue){
if(!_isEditing){
_isEditing=YES;
objj_msgSend(_75,"textDidBeginEditing:",objj_msgSend(CPNotification,"notificationWithName:object:userInfo:",CPControlTextDidBeginEditingNotification,_75,nil));
}
objj_msgSend(_75,"textDidChange:",objj_msgSend(CPNotification,"notificationWithName:object:userInfo:",CPControlTextDidChangeNotification,_75,nil));
}
}
}),new objj_method(sel_getUid("textDidBlur:"),function(_7b,_7c,_7d){
with(_7b){
if(objj_msgSend(_7d,"object")!=_7b){
return;
}
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotification:",_7d);
}
}),new objj_method(sel_getUid("textDidFocus:"),function(_7e,_7f,_80){
with(_7e){
if(objj_msgSend(_80,"object")!=_7e){
return;
}
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotification:",_80);
}
}),new objj_method(sel_getUid("textDidChange:"),function(_81,_82,_83){
with(_81){
if(objj_msgSend(_83,"object")!==_81){
return;
}
objj_msgSend(_81,"_continuouslyReverseSetBinding");
objj_msgSendSuper({receiver:_81,super_class:objj_getClass("CPTextField").super_class},"textDidChange:",_83);
}
}),new objj_method(sel_getUid("objectValue"),function(_84,_85){
with(_84){
return objj_msgSendSuper({receiver:_84,super_class:objj_getClass("CPTextField").super_class},"objectValue");
}
}),new objj_method(sel_getUid("_setStringValue:"),function(_86,_87,_88){
with(_86){
return objj_msgSend(_86,"_setStringValue:isNewValue:errorDescription:",_88,YES,nil);
}
}),new objj_method(sel_getUid("_setStringValue:isNewValue:errorDescription:"),function(_89,_8a,_8b,_8c,_8d){
with(_89){
_stringValue=_8b;
var _8e=_8b,_8f=objj_msgSend(_89,"formatter"),_90=YES;
if(_8f){
var _91=nil;
if(objj_msgSend(_8f,"getObjectValue:forString:errorDescription:",function(_92){
if(arguments.length){
return _91=_92;
}
return _91;
...
_8c|=_8e!==objj_msgSendSuper({receiver:_89,super_class:objj_getClass("CPTextField").super_class},"objectValue");
}
if(_8c){
objj_msgSend(_89,"willChangeValueForKey:","objectValue");
objj_msgSendSuper({receiver:_89,super_class:objj_getClass("CPTextField").super_class},"setObjectValue:",_8e);
objj_msgSend(_89,"_updatePlaceholderState");
objj_msgSend(_89,"didChangeValueForKey:","objectValue");
}
return _90;
}
}),new objj_method(sel_getUid("setObjectValue:"),function(_93,_94,_95){
with(_93){
objj_msgSendSuper({receiver:_93,super_class:objj_getClass("CPTextField").super_class},"setObjectValue:",_95);
var _96=objj_msgSend(_93,"formatter");
if(_96){
var _97=objj_msgSend(_93,"hasThemeState:",CPThemeStateEditing)?objj_msgSend(_96,"editingStringForObjectValue:",_95):objj_msgSend(_96,"stringForObjectValue:",_95);
if(_97===nil){
var _98=nil;
if(objj_msgSend(_96,"getObjectValue:forString:errorDescription:",function(_99){
if(arguments.length){
return _98=_99;
}
return _98;
...
objj_msgSendSuper({receiver:_93,super_class:objj_getClass("CPTextField").super_class},"setObjectValue:",_98);
}
}
_stringValue=objj_msgSend(_93,"stringValue");
if(_4===_93||objj_msgSend(objj_msgSend(_93,"window"),"firstResponder")===_93){
objj_msgSend(_93,"_inputElement").value=_stringValue;
}
objj_msgSend(_93,"_updatePlaceholderState");
}
}),new objj_method(sel_getUid("_updatePlaceholderState"),function(_9a,_9b){
with(_9a){
if((!_stringValue||_stringValue.length===0)&&!objj_msgSend(_9a,"hasThemeState:",CPThemeStateEditing)){
objj_msgSend(_9a,"setThemeState:",CPTextFieldStatePlaceholder);
}else{
objj_msgSend(_9a,"unsetThemeState:",CPTextFieldStatePlaceholder);
}
}
}),new objj_method(sel_getUid("setPlaceholderString:"),function(_9c,_9d,_9e){
with(_9c){
if(_placeholderString===_9e){
return;
}
_placeholderString=_9e;
if(objj_msgSend(_9c,"hasThemeState:",CPTextFieldStatePlaceholder)){
objj_msgSend(_9c,"setNeedsLayout");
objj_msgSend(_9c,"setNeedsDisplay:",YES);
}
}
}),new objj_method(sel_getUid("placeholderString"),function(_9f,_a0){
with(_9f){
return _placeholderString;
}
}),new objj_method(sel_getUid("sizeToFit"),function(_a1,_a2){
with(_a1){
objj_msgSend(_a1,"setFrameSize:",objj_msgSend(_a1,"_minimumFrameSize"));
}
}),new objj_method(sel_getUid("_minimumFrameSize"),function(_a3,_a4){
with(_a3){
var _a5=objj_msgSend(_a3,"frameSize"),_a6=objj_msgSend(_a3,"currentValueForThemeAttribute:","content-inset"),_a7=objj_msgSend(_a3,"currentValueForThemeAttribute:","min-size"),_a8=objj_msgSend(_a3,"currentValueForThemeAttribute:","max-size"),_a9=objj_msgSend(_a3,"lineBreakMode"),_aa=(_stringValue||" "),_ab={width:_a5.width,height:_a5.height},_ac=objj_msgSend(_a3,"currentValueForThemeAttribute:","font");
_ab.width-=_a6.left+_a6.right;
_ab.height-=_a6.top+_a6.bottom;
if(_a5.width!==0&&!objj_msgSend(_a3,"isBezeled")&&(_a9===CPLineBreakByWordWrapping||_a9===CPLineBreakByCharWrapping)){
_ab=objj_msgSend(_aa,"sizeWithFont:inWidth:",_ac,_ab.width);
}else{
_ab=objj_msgSend(_aa,"sizeWithFont:",_ac);
}
_a5.height=_ab.height+_a6.top+_a6.bottom;
if(objj_msgSend(_a3,"isBezeled")){
_a5.height=MAX(_a5.height,_a7.height);
if(_a8.width>0){
_a5.width=MIN(_a5.width,_a8.width);
}
if(_a8.height>0){
_a5.height=MIN(_a5.height,_a8.height);
}
}else{
_a5.width=_ab.width+_a6.left+_a6.right;
}
_a5.width=MAX(_a5.width,_a7.width);
return _a5;
}
}),new objj_method(sel_getUid("selectText:"),function(_ad,_ae,_af){
with(_ad){
if((objj_msgSend(_ad,"isEditable")||objj_msgSend(_ad,"isSelectable"))){
var _b0=objj_msgSend(_ad,"_inputElement");
if(objj_msgSend(objj_msgSend(_ad,"window"),"firstResponder")===_ad){
window.setTimeout(function(){
_b0.select();
},0);
}else{
if(objj_msgSend(_ad,"window")!==nil&&objj_msgSend(objj_msgSend(_ad,"window"),"makeFirstResponder:",_ad)){
window.setTimeout(function(){
objj_msgSend(_ad,"selectText:",_af);
},0);
}
}
}
}
}),new objj_method(sel_getUid("copy:"),function(_b1,_b2,_b3){
with(_b1){
if(!objj_msgSend(CPPlatform,"isBrowser")){
var _b4=objj_msgSend(_b1,"selectedRange");
if(_b4.length<1){
return;
}
var _b5=objj_msgSend(CPPasteboard,"generalPasteboard"),_b6=objj_msgSend(_stringValue,"substringWithRange:",_b4);
objj_msgSend(_b5,"declareTypes:owner:",[CPStringPboardType],nil);
objj_msgSend(_b5,"setString:forType:",_b6,CPStringPboardType);
}
}
}),new objj_method(sel_getUid("cut:"),function(_b7,_b8,_b9){
with(_b7){
if(!objj_msgSend(CPPlatform,"isBrowser")){
objj_msgSend(_b7,"copy:",_b9);
objj_msgSend(_b7,"deleteBackward:",_b9);
}else{
objj_msgSend(CPTimer,"scheduledTimerWithTimeInterval:target:selector:userInfo:repeats:",0,_b7,sel_getUid("keyUp:"),nil,NO);
}
}
}),new objj_method(sel_getUid("paste:"),function(_ba,_bb,_bc){
with(_ba){
if(!objj_msgSend(CPPlatform,"isBrowser")){
var _bd=objj_msgSend(CPPasteboard,"generalPasteboard");
if(!objj_msgSend(objj_msgSend(_bd,"types"),"containsObject:",CPStringPboardType)){
return;
}
objj_msgSend(_ba,"deleteBackward:",_bc);
var _be=objj_msgSend(_ba,"selectedRange"),_bf=objj_msgSend(_bd,"stringForType:",CPStringPboardType),_c0=objj_msgSend(_stringValue,"stringByReplacingCharactersInRange:withString:",_be,_bf);
objj_msgSend(_ba,"setStringValue:",_c0);
objj_msgSend(_ba,"setSelectedRange:",CPMakeRange(_be.location+_bf.length,0));
}else{
objj_msgSend(CPTimer,"scheduledTimerWithTimeInterval:target:selector:userInfo:repeats:",0,_ba,sel_getUid("keyUp:"),nil,NO);
}
}
}),new objj_method(sel_getUid("selectedRange"),function(_c1,_c2){
with(_c1){
if(objj_msgSend(objj_msgSend(_c1,"window"),"firstResponder")!==_c1){
return CPMakeRange(0,0);
}
try{
var _c3=objj_msgSend(_c1,"_inputElement"),_c4=_c3.selectionStart,_c5=_c3.selectionEnd;
if(objj_msgSend(_c4,"isKindOfClass:",CPNumber)){
return CPMakeRange(_c4,_c5-_c4);
}
var _c6=_c3.ownerDocument||_c3.document,_c7=_c6.selection.createRange(),_c8=_c3.createTextRange();
if(_c8.inRange(_c7)){
_c8.setEndPoint("EndToStart",_c7);
return CPMakeRange(_c8.text.length,_c7.text.length);
}
}
catch(e){
}
...
}),new objj_method(sel_getUid("setSelectedRange:"),function(_c9,_ca,_cb){
with(_c9){
if(!objj_msgSend(objj_msgSend(_c9,"window"),"firstResponder")===_c9){
return;
}
var _cc=objj_msgSend(_c9,"_inputElement");
try{
if(objj_msgSend(_cc.selectionStart,"isKindOfClass:",CPNumber)){
_cc.selectionStart=_cb.location;
_cc.selectionEnd=CPMaxRange(_cb);
}else{
var _cd=_cc.ownerDocument||_cc.document,_ce=_cd.selection.createRange(),_cf=_cc.createTextRange();
if(_cf.inRange(_ce)){
_cf.collapse(true);
_cf.move("character",_cb.location);
_cf.moveEnd("character",_cb.length);
_cf.select();
}
}
}
...
}),new objj_method(sel_getUid("selectAll:"),function(_d0,_d1,_d2){
with(_d0){
objj_msgSend(_d0,"selectText:",_d2);
}
}),new objj_method(sel_getUid("deleteBackward:"),function(_d3,_d4,_d5){
with(_d3){
var _d6=objj_msgSend(_d3,"selectedRange");
if(_d6.length<2){
return;
}
_d6.location+=1;
_d6.length-=1;
var _d7=objj_msgSend(_stringValue,"stringByReplacingCharactersInRange:withString:",_d6,"");
objj_msgSend(_d3,"setStringValue:",_d7);
objj_msgSend(_d3,"setSelectedRange:",CPMakeRange(_d6.location,0));
}
}),new objj_method(sel_getUid("setDelegate:"),function(_d8,_d9,_da){
with(_d8){
var _db=objj_msgSend(CPNotificationCenter,"defaultCenter");
if(_delegate){
objj_msgSend(_db,"removeObserver:name:object:",_delegate,CPControlTextDidBeginEditingNotification,_d8);
objj_msgSend(_db,"removeObserver:name:object:",_delegate,CPControlTextDidChangeNotification,_d8);
objj_msgSend(_db,"removeObserver:name:object:",_delegate,CPControlTextDidEndEditingNotification,_d8);
objj_msgSend(_db,"removeObserver:name:object:",_delegate,CPTextFieldDidFocusNotification,_d8);
objj_msgSend(_db,"removeObserver:name:object:",_delegate,CPTextFieldDidBlurNotification,_d8);
}
_delegate=_da;
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidBeginEditing:"))){
objj_msgSend(_db,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidBeginEditing:"),CPControlTextDidBeginEditingNotification,_d8);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidChange:"))){
objj_msgSend(_db,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidChange:"),CPControlTextDidChangeNotification,_d8);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidEndEditing:"))){
objj_msgSend(_db,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidEndEditing:"),CPControlTextDidEndEditingNotification,_d8);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidFocus:"))){
objj_msgSend(_db,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidFocus:"),CPTextFieldDidFocusNotification,_d8);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidBlur:"))){
objj_msgSend(_db,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidBlur:"),CPTextFieldDidBlurNotification,_d8);
}
}
...
}),new objj_method(sel_getUid("contentRectForBounds:"),function(_de,_df,_e0){
with(_de){
var _e1=objj_msgSend(_de,"currentValueForThemeAttribute:","content-inset");
if(!_e1){
return _e0;
}
_e0.origin.x+=_e1.left;
_e0.origin.y+=_e1.top;
_e0.size.width-=_e1.left+_e1.right;
_e0.size.height-=_e1.top+_e1.bottom;
return _e0;
}
}),new objj_method(sel_getUid("bezelRectForBounds:"),function(_e2,_e3,_e4){
with(_e2){
var _e5=objj_msgSend(_e2,"currentValueForThemeAttribute:","bezel-inset");
if(((_e5).top===0&&(_e5).right===0&&(_e5).bottom===0&&(_e5).left===0)){
return _e4;
}
_e4.origin.x+=_e5.left;
_e4.origin.y+=_e5.top;
_e4.size.width-=_e5.left+_e5.right;
_e4.size.height-=_e5.top+_e5.bottom;
return _e4;
}
}),new objj_method(sel_getUid("rectForEphemeralSubviewNamed:"),function(_e6,_e7,_e8){
with(_e6){
if(_e8==="bezel-view"){
return objj_msgSend(_e6,"bezelRectForBounds:",objj_msgSend(_e6,"bounds"));
}else{
if(_e8==="content-view"){
return objj_msgSend(_e6,"contentRectForBounds:",objj_msgSend(_e6,"bounds"));
}
}
return objj_msgSendSuper({receiver:_e6,super_class:objj_getClass("CPTextField").super_class},"rectForEphemeralSubviewNamed:",_e8);
}
}),new objj_method(sel_getUid("createEphemeralSubviewNamed:"),function(_e9,_ea,_eb){
with(_e9){
if(_eb==="bezel-view"){
var _ec=objj_msgSend(objj_msgSend(CPView,"alloc"),"initWithFrame:",{origin:{x:0,y:0},size:{width:0,height:0}});
objj_msgSend(_ec,"setHitTests:",NO);
return _ec;
}else{
var _ec=objj_msgSend(objj_msgSend(_CPImageAndTextView,"alloc"),"initWithFrame:",{origin:{x:0,y:0},size:{width:0,height:0}});
objj_msgSend(_ec,"setHitTests:",NO);
return _ec;
}
return objj_msgSendSuper({receiver:_e9,super_class:objj_getClass("CPTextField").super_class},"createEphemeralSubviewNamed:",_eb);
}
}),new objj_method(sel_getUid("layoutSubviews"),function(_ed,_ee){
with(_ed){
var _ef=objj_msgSend(_ed,"layoutEphemeralSubviewNamed:positioned:relativeToEphemeralSubviewNamed:","bezel-view",CPWindowBelow,"content-view");
if(_ef){
objj_msgSend(_ef,"setBackgroundColor:",objj_msgSend(_ed,"currentValueForThemeAttribute:","bezel-color"));
}
var _f0=objj_msgSend(_ed,"layoutEphemeralSubviewNamed:positioned:relativeToEphemeralSubviewNamed:","content-view",CPWindowAbove,"bezel-view");
if(_f0){
objj_msgSend(_f0,"setHidden:",objj_msgSend(_ed,"hasThemeState:",CPThemeStateEditing));
var _f1="";
if(objj_msgSend(_ed,"hasThemeState:",CPTextFieldStatePlaceholder)){
_f1=objj_msgSend(_ed,"placeholderString");
}else{
_f1=_stringValue;
if(objj_msgSend(_ed,"isSecure")){
_f1=_f2(_f1);
}
}
objj_msgSend(_f0,"setText:",_f1);
objj_msgSend(_f0,"setTextColor:",objj_msgSend(_ed,"currentValueForThemeAttribute:","text-color"));
objj_msgSend(_f0,"setFont:",objj_msgSend(_ed,"currentValueForThemeAttribute:","font"));
objj_msgSend(_f0,"setAlignment:",objj_msgSend(_ed,"currentValueForThemeAttribute:","alignment"));
objj_msgSend(_f0,"setVerticalAlignment:",objj_msgSend(_ed,"currentValueForThemeAttribute:","vertical-alignment"));
objj_msgSend(_f0,"setLineBreakMode:",objj_msgSend(_ed,"currentValueForThemeAttribute:","line-break-mode"));
objj_msgSend(_f0,"setTextShadowColor:",objj_msgSend(_ed,"currentValueForThemeAttribute:","text-shadow-color"));
objj_msgSend(_f0,"setTextShadowOffset:",objj_msgSend(_ed,"currentValueForThemeAttribute:","text-shadow-offset"));
}
}
}),new objj_method(sel_getUid("takeValueFromKeyPath:ofObjects:"),function(_f3,_f4,_f5,_f6){
with(_f3){
var _f7=_f6.length,_f8=objj_msgSend(_f6[0],"valueForKeyPath:",_f5);
objj_msgSend(_f3,"setStringValue:",_f8);
objj_msgSend(_f3,"setPlaceholderString:","");
while(_f7-->1){
if(_f8!==objj_msgSend(_f6[_f7],"valueForKeyPath:",_f5)){
objj_msgSend(_f3,"setPlaceholderString:","Multiple Values");
objj_msgSend(_f3,"setStringValue:","");
}
}
}
})]);
class_addMethods(_e,[new objj_method(sel_getUid("textFieldWithStringValue:placeholder:width:"),function(_f9,_fa,_fb,_fc,_fd){
with(_f9){
return objj_msgSend(_f9,"textFieldWithStringValue:placeholder:width:theme:",_fb,_fc,_fd,objj_msgSend(CPTheme,"defaultTheme"));
}
}),new objj_method(sel_getUid("textFieldWithStringValue:placeholder:width:theme:"),function(_fe,_ff,_100,_101,_102,_103){
with(_fe){
var _104=objj_msgSend(objj_msgSend(_fe,"alloc"),"initWithFrame:",CGRectMake(0,0,_102,29));
objj_msgSend(_104,"setTheme:",_103);
objj_msgSend(_104,"setStringValue:",_100);
objj_msgSend(_104,"setPlaceholderString:",_101);
objj_msgSend(_104,"setBordered:",YES);
objj_msgSend(_104,"setBezeled:",YES);
objj_msgSend(_104,"setEditable:",YES);
objj_msgSend(_104,"sizeToFit");
return _104;
}
}),new objj_method(sel_getUid("roundedTextFieldWithStringValue:placeholder:width:"),function(self,_105,_106,_107,_108){
with(self){
return objj_msgSend(self,"roundedTextFieldWithStringValue:placeholder:width:theme:",_106,_107,_108,objj_msgSend(CPTheme,"defaultTheme"));
}
}),new objj_method(sel_getUid("roundedTextFieldWithStringValue:placeholder:width:theme:"),function(self,_109,_10a,_10b,_10c,_10d){
with(self){
var _10e=objj_msgSend(objj_msgSend(CPTextField,"alloc"),"initWithFrame:",CGRectMake(0,0,_10c,29));
objj_msgSend(_10e,"setTheme:",_10d);
objj_msgSend(_10e,"setStringValue:",_10a);
objj_msgSend(_10e,"setPlaceholderString:",_10b);
objj_msgSend(_10e,"setBezelStyle:",CPTextFieldRoundedBezel);
objj_msgSend(_10e,"setBordered:",YES);
objj_msgSend(_10e,"setBezeled:",YES);
objj_msgSend(_10e,"setEditable:",YES);
objj_msgSend(_10e,"sizeToFit");
return _10e;
}
}),new objj_method(sel_getUid("labelWithTitle:"),function(self,_10f,_110){
with(self){
return objj_msgSend(self,"labelWithTitle:theme:",_110,objj_msgSend(CPTheme,"defaultTheme"));
}
}),new objj_method(sel_getUid("labelWithTitle:theme:"),function(self,_111,_112,_113){
with(self){
var _114=objj_msgSend(objj_msgSend(self,"alloc"),"init");
objj_msgSend(_114,"setStringValue:",_112);
objj_msgSend(_114,"sizeToFit");
return _114;
}
}),new objj_method(sel_getUid("defaultThemeClass"),function(self,_115){
with(self){
return "textfield";
}
}),new objj_method(sel_getUid("_binderClassForBinding:"),function(self,_116,_117){
with(self){
if(_117===CPValueBinding){
return objj_msgSend(_CPTextFieldValueBinder,"class");
}
return objj_msgSendSuper({receiver:self,super_class:objj_getMetaClass("CPTextField").super_class},"_binderClassForBinding:",_117);
}
}),new objj_method(sel_getUid("themeAttributes"),function(self,_118){
with(self){
...
var _f2=function(_119){
if(!_119){
return "";
}
return Array(_119.length+1).join(_c);
};
var _11a="CPTextFieldIsEditableKey",_11b="CPTextFieldIsSelectableKey",_11c="CPTextFieldIsBorderedKey",_11d="CPTextFieldIsBezeledKey",_11e="CPTextFieldBezelStyleKey",_11f="CPTextFieldDrawsBackgroundKey",_120="CPTextFieldLineBreakModeKey",_121="CPTextFieldAlignmentKey",_122="CPTextFieldBackgroundColorKey",_123="CPTextFieldPlaceholderStringKey";
var _d=objj_getClass("CPTextField");
if(!_d){
throw new SyntaxError("*** Could not find definition for class \"CPTextField\"");
}
var _e=_d.isa;
class_addMethods(_d,[new objj_method(sel_getUid("initWithCoder:"),function(self,_124,_125){
with(self){
self=objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPTextField").super_class},"initWithCoder:",_125);
if(self){
objj_msgSend(self,"setEditable:",objj_msgSend(_125,"decodeBoolForKey:",_11a));
objj_msgSend(self,"setSelectable:",objj_msgSend(_125,"decodeBoolForKey:",_11b));
objj_msgSend(self,"setDrawsBackground:",objj_msgSend(_125,"decodeBoolForKey:",_11f));
objj_msgSend(self,"setTextFieldBackgroundColor:",objj_msgSend(_125,"decodeObjectForKey:",_122));
objj_msgSend(self,"setLineBreakMode:",objj_msgSend(_125,"decodeIntForKey:",_120));
objj_msgSend(self,"setAlignment:",objj_msgSend(_125,"decodeIntForKey:",_121));
objj_msgSend(self,"setPlaceholderString:",objj_msgSend(_125,"decodeObjectForKey:",_123));
}
return self;
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(self,_126,_127){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPTextField").super_class},"encodeWithCoder:",_127);
objj_msgSend(_127,"encodeBool:forKey:",_isEditable,_11a);
objj_msgSend(_127,"encodeBool:forKey:",_isSelectable,_11b);
objj_msgSend(_127,"encodeBool:forKey:",_drawsBackground,_11f);
objj_msgSend(_127,"encodeObject:forKey:",_textFieldBackgroundColor,_122);
objj_msgSend(_127,"encodeInt:forKey:",objj_msgSend(self,"lineBreakMode"),_120);
objj_msgSend(_127,"encodeInt:forKey:",objj_msgSend(self,"alignment"),_121);
objj_msgSend(_127,"encodeObject:forKey:",_placeholderString,_123);
}
})]);
var _d=objj_allocateClassPair(CPBinder,"_CPTextFieldValueBinder"),_e=_d.isa;
objj_registerClassPair(_d);
class_addMethods(_d,[new objj_method(sel_getUid("setValueFor:"),function(self,_128,_129){
with(self){
var _12a=objj_msgSend(_info,"objectForKey:",CPObservedObjectKey),_12b=objj_msgSend(_info,"objectForKey:",CPObservedKeyPathKey),_12c=objj_msgSend(_info,"objectForKey:",CPOptionsKey),_12d=objj_msgSend(_12a,"valueForKeyPath:",_12b),_12e=CPIsControllerMarker(_12d);
if(_12e){
switch(_12d){
case CPMultipleValuesMarker:
_12d=objj_msgSend(_12c,"objectForKey:",CPMultipleValuesPlaceholderBindingOption)||"Multiple Values";
break;
case CPNoSelectionMarker:
_12d=objj_msgSend(_12c,"objectForKey:",CPNoSelectionPlaceholderBindingOption)||"No Selection";
break;
case CPNotApplicableMarker:
if(objj_msgSend(_12c,"objectForKey:",CPRaisesForNotApplicableKeysBindingOption)){
objj_msgSend(CPException,"raise:reason:",CPGenericException,"can't transform non applicable key on: "+_source+" value: "+_12d);
}
_12d=objj_msgSend(_12c,"objectForKey:",CPNotApplicablePlaceholderBindingOption)||"Not Applicable";
break;
case CPNullMarker:
_12d=objj_msgSend(_12c,"objectForKey:",CPNullPlaceholderBindingOption)||"";
break;
}
objj_msgSend(_source,"setPlaceholderString:",_12d);
objj_msgSend(_source,"setObjectValue:",nil);
}else{
_12d=objj_msgSend(self,"transformValue:withOptions:",_12d,_12c);
objj_msgSend(_source,"setObjectValue:",_12d);
}
}
})]);
...
p;21;_CPImageAndTextView.jt;14331;@STATIC;1.0;I;21;Foundation/CPString.ji;9;CPColor.ji;8;CPFont.ji;9;CPImage.ji;8;CPView.ji;11;CPControl.jt;14219;
objj_executeFile("Foundation/CPString.j",NO);
objj_executeFile("CPColor.j",YES);
objj_executeFile("CPFont.j",YES);
objj_executeFile("CPImage.j",YES);
...
var _60=_5e&&!!_textShadowColor,_61=!!_DOMTextShadowElement;
if(_60!==_61){
if(_61){
...
p;9;CPTheme.jt;13877;@STATIC;1.0;I;21;Foundation/CPObject.jI;21;Foundation/CPString.jI;30;Foundation/CPKeyedUnarchiver.jt;13770;
objj_executeFile("Foundation/CPObject.j",NO);
objj_executeFile("Foundation/CPString.j",NO);
objj_executeFile("Foundation/CPKeyedUnarchiver.j",NO);
var _1={},_2=[],_3=nil,_4=nil;
var _5=objj_allocateClassPair(CPObject,"CPTheme"),_6=_5.isa;
class_addIvars(_5,[new objj_ivar("_name"),new objj_ivar("_attributes")]);
objj_registerClassPair(_5);
class_addMethods(_5,[new objj_method(sel_getUid("initWithName:"),function(_7,_8,_9){
with(_7){
_7=objj_msgSendSuper({receiver:_7,super_class:objj_getClass("CPTheme").super_class},"init");
if(_7){
_name=_9;
_attributes=objj_msgSend(CPDictionary,"dictionary");
_1[_name]=_7;
if(!objj_msgSend(_2,"containsObject:",_name)){
_2.push(_name);
}
}
return _7;
...
}),new objj_method(sel_getUid("classNames"),function(_c,_d){
with(_c){
return objj_msgSend(_attributes,"allKeys");
}
}),new objj_method(sel_getUid("attributesForClass:"),function(_e,_f,_10){
with(_e){
if(!_10){
return nil;
}
var _11=nil;
if(objj_msgSend(_10,"isKindOfClass:",objj_msgSend(CPString,"class"))){
var _12=CPClassFromString(_10);
if(_12){
_10=_12;
}else{
_11=_10;
...
if(!_11){
if(objj_msgSend(_10,"isKindOfClass:",objj_msgSend(CPView,"class"))){
if(objj_msgSend(_10,"respondsToSelector:",sel_getUid("defaultThemeClass"))){
_11=objj_msgSend(_10,"defaultThemeClass");
}else{
if(objj_msgSend(_10,"respondsToSelector:",sel_getUid("themeClass"))){
CPLog.warn("%@ themeClass is deprecated in favor of defaultThemeClass",CPStringFromClass(objj_msgSend(anObject,"class")));
_11=objj_msgSend(_10,"themeClass");
}else{
return nil;
}
}
...
return objj_msgSend(_attributes,"objectForKey:",_11);
}
}),new objj_method(sel_getUid("attributeNamesForClass:"),function(_13,_14,_15){
with(_13){
var _16=objj_msgSend(_13,"attributesForClass:",_15);
if(_16){
return objj_msgSend(_16,"allKeys");
}else{
return objj_msgSend(CPArray,"array");
}
}
}),new objj_method(sel_getUid("attributeWithName:forClass:"),function(_17,_18,_19,_1a){
with(_17){
var _1b=objj_msgSend(_17,"attributesForClass:",_1a);
if(!_1b){
return nil;
}
return objj_msgSend(_1b,"objectForKey:",_19);
}
}),new objj_method(sel_getUid("valueForAttributeWithName:forClass:"),function(_1c,_1d,_1e,_1f){
with(_1c){
return objj_msgSend(_1c,"valueForAttributeWithName:inState:forClass:",_1e,CPThemeStateNormal,_1f);
}
}),new objj_method(sel_getUid("valueForAttributeWithName:inState:forClass:"),function(_20,_21,_22,_23,_24){
with(_20){
var _25=objj_msgSend(_20,"attributeWithName:forClass:",_22,_24);
if(!_25){
return nil;
}
return objj_msgSend(_25,"valueForState:",_23);
}
}),new objj_method(sel_getUid("takeThemeFromObject:"),function(_26,_27,_28){
with(_26){
var _29=objj_msgSend(_28,"_themeAttributeDictionary"),_2a=nil,_2b=objj_msgSend(_29,"keyEnumerator"),_2c=objj_msgSend(_28,"themeClass");
while(_2a=objj_msgSend(_2b,"nextObject")){
objj_msgSend(_26,"_recordAttribute:forClass:",objj_msgSend(_29,"objectForKey:",_2a),_2c);
}
}
}),new objj_method(sel_getUid("_recordAttribute:forClass:"),function(_2d,_2e,_2f,_30){
with(_2d){
if(!objj_msgSend(_2f,"hasValues")){
return;
}
var _31=objj_msgSend(_attributes,"objectForKey:",_30);
if(!_31){
_31=objj_msgSend(CPDictionary,"dictionary");
objj_msgSend(_attributes,"setObject:forKey:",_31,_30);
}
var _32=objj_msgSend(_2f,"name"),_33=objj_msgSend(_31,"objectForKey:",_32);
if(_33){
objj_msgSend(_31,"setObject:forKey:",objj_msgSend(_33,"attributeMergedWithAttribute:",_2f),_32);
}else{
objj_msgSend(_31,"setObject:forKey:",_2f,_32);
}
}
})]);
class_addMethods(_6,[new objj_method(sel_getUid("setDefaultTheme:"),function(_34,_35,_36){
with(_34){
_3=_36;
}
}),new objj_method(sel_getUid("defaultTheme"),function(_37,_38){
with(_37){
return _3;
}
}),new objj_method(sel_getUid("setDefaultHudTheme:"),function(_39,_3a,_3b){
with(_39){
_4=_3b;
}
}),new objj_method(sel_getUid("defaultHudTheme"),function(_3c,_3d){
with(_3c){
if(!_4){
_4=objj_msgSend(CPTheme,"themeNamed:",objj_msgSend(objj_msgSend(_3c,"defaultTheme"),"name")+"-HUD");
}
return _4;
}
}),new objj_method(sel_getUid("themeNamed:"),function(_3e,_3f,_40){
with(_3e){
return _1[_40];
}
}),new objj_method(sel_getUid("allThemeNames"),function(_41,_42){
with(_41){
return objj_msgSend(_2,"copy");
}
}),new objj_method(sel_getUid("themeForView:"),function(_43,_44,_45){
with(_43){
var _46=nil;
if(class_isMetaClass(_45.isa)){
_46=objj_msgSend(_45,"defaultThemeClass");
}else{
_46=objj_msgSend(_45,"themeClass");
}
if(_46){
var _47=_2.length;
while(_47--){
var _48=_1[_2[_47]];
if(objj_msgSend(_48._attributes,"containsKey:",_46)){
return _48;
}
}
}
...
var _49="CPThemeNameKey",_4a="CPThemeAttributesKey";
var _5=objj_getClass("CPTheme");
if(!_5){
throw new SyntaxError("*** Could not find definition for class \"CPTheme\"");
}
var _6=_5.isa;
class_addMethods(_5,[new objj_method(sel_getUid("initWithCoder:"),function(_4b,_4c,_4d){
with(_4b){
_4b=objj_msgSendSuper({receiver:_4b,super_class:objj_getClass("CPTheme").super_class},"init");
if(_4b){
_name=objj_msgSend(_4d,"decodeObjectForKey:",_49);
_attributes=objj_msgSend(_4d,"decodeObjectForKey:",_4a);
_1[_name]=_4b;
if(!objj_msgSend(_2,"containsObject:",_name)){
_2.push(_name);
}
...
with(_4e){
objj_msgSend(_50,"encodeObject:forKey:",_name,_49);
objj_msgSend(_50,"encodeObject:forKey:",_attributes,_4a);
}
})]);
var _5=objj_allocateClassPair(CPKeyedUnarchiver,"_CPThemeKeyedUnarchiver"),_6=_5.isa;
class_addIvars(_5,[new objj_ivar("_bundle")]);
objj_registerClassPair(_5);
class_addMethods(_5,[new objj_method(sel_getUid("initForReadingWithData:bundle:"),function(_51,_52,_53,_54){
with(_51){
_51=objj_msgSendSuper({receiver:_51,super_class:objj_getClass("_CPThemeKeyedUnarchiver").super_class},"initForReadingWithData:",_53);
if(_51){
_bundle=_54;
}
return _51;
}
}),new objj_method(sel_getUid("bundle"),function(_55,_56){
with(_55){
return _bundle;
}
}),new objj_method(sel_getUid("awakenCustomResources"),function(_57,_58){
with(_57){
return YES;
}
})]);
var _59={},_5a={},_5b=0;
CPThemeState=function(_5c){
var _5d=_59[_5c];
if(_5d===undefined){
if(_5c.indexOf("+")===-1){
_5d=1<<_5b++;
}else{
var _5d=0,_5e=_5c.split("+"),_5f=_5e.length;
while(_5f--){
var _60=_5e[_5f],_61=_59[_60];
if(_61===undefined){
_61=1<<_5b++;
_59[_60]=_61;
_5a[_61]=_60;
...
_5a[0]="normal";
CPThemeStateNormal=_59["normal"]=0;
...
var _5=objj_allocateClassPair(CPObject,"_CPThemeAttribute"),_6=_5.isa;
class_addIvars(_5,[new objj_ivar("_name"),new objj_ivar("_defaultValue"),new objj_ivar("_values"),new objj_ivar("_cache"),new objj_ivar("_parentAttribute")]);
objj_registerClassPair(_5);
class_addMethods(_5,[new objj_method(sel_getUid("values"),function(_65,_66){
with(_65){
return _values;
}
}),new objj_method(sel_getUid("initWithName:defaultValue:"),function(_67,_68,_69,_6a){
with(_67){
_67=objj_msgSendSuper({receiver:_67,super_class:objj_getClass("_CPThemeAttribute").super_class},"init");
if(_67){
_cache={};
_name=_69;
_defaultValue=_6a;
...
}),new objj_method(sel_getUid("name"),function(_6b,_6c){
with(_6b){
return _name;
}
}),new objj_method(sel_getUid("defaultValue"),function(_6d,_6e){
with(_6d){
return _defaultValue;
}
}),new objj_method(sel_getUid("hasValues"),function(_6f,_70){
with(_6f){
return objj_msgSend(_values,"count")>0;
}
}),new objj_method(sel_getUid("isTrivial"),function(_71,_72){
with(_71){
return (objj_msgSend(_values,"count")===1)&&(Number(objj_msgSend(_values,"allKeys")[0])===CPThemeStateNormal);
}
}),new objj_method(sel_getUid("setValue:"),function(_73,_74,_75){
with(_73){
_cache={};
if(_75===undefined||_75===nil){
_values=objj_msgSend(CPDictionary,"dictionary");
}else{
_values=objj_msgSend(CPDictionary,"dictionaryWithObject:forKey:",_75,String(CPThemeStateNormal));
}
}
}),new objj_method(sel_getUid("setValue:forState:"),function(_76,_77,_78,_79){
with(_76){
_cache={};
if((_78===undefined)||(_78===nil)){
objj_msgSend(_values,"removeObjectForKey:",String(_79));
}else{
objj_msgSend(_values,"setObject:forKey:",_78,String(_79));
}
}
}),new objj_method(sel_getUid("value"),function(_7a,_7b){
with(_7a){
return objj_msgSend(_7a,"valueForState:",CPThemeStateNormal);
}
}),new objj_method(sel_getUid("valueForState:"),function(_7c,_7d,_7e){
with(_7c){
var _7f=_cache[_7e];
if(_7f!==undefined){
return _7f;
}
_7f=objj_msgSend(_values,"objectForKey:",String(_7e));
if((_7f===undefined||_7f===nil)&&_7e!==CPThemeStateNormal){
if(_7e&(_7e-1)){
var _80=0,_81=objj_msgSend(_values,"allKeys"),_82=_81.length;
while(_82--){
var _83=Number(_81[_82]);
if((_83&_7e)===_83){
var _84=_85[_83];
if(_84===undefined){
_84=_86(_83);
...
if(_84>_80){
_80=_84;
_7f=objj_msgSend(_values,"objectForKey:",String(_83));
}
}
}
}
if(_7f===undefined||_7f===nil){
_7f=objj_msgSend(_values,"objectForKey:",String(CPThemeStateNormal));
}
}
if(_7f===undefined||_7f===nil){
_7f=objj_msgSend(_parentAttribute,"valueForState:",_7e);
}
if(_7f===undefined||_7f===nil){
_7f=_defaultValue;
}
...
}),new objj_method(sel_getUid("setParentAttribute:"),function(_87,_88,_89){
with(_87){
if(_parentAttribute===_89){
return;
}
_cache={};
_parentAttribute=_89;
}
}),new objj_method(sel_getUid("attributeMergedWithAttribute:"),function(_8a,_8b,_8c){
with(_8a){
var _8d=objj_msgSend(objj_msgSend(_CPThemeAttribute,"alloc"),"initWithName:defaultValue:",_name,_defaultValue);
_8d._values=objj_msgSend(_values,"copy");
objj_msgSend(_8d._values,"addEntriesFromDictionary:",_8c._values);
return _8d;
}
})]);
var _5=objj_getClass("_CPThemeAttribute");
if(!_5){
throw new SyntaxError("*** Could not find definition for class \"_CPThemeAttribute\"");
}
var _6=_5.isa;
class_addMethods(_5,[new objj_method(sel_getUid("initWithCoder:"),function(_8e,_8f,_90){
with(_8e){
_8e=objj_msgSendSuper({receiver:_8e,super_class:objj_getClass("_CPThemeAttribute").super_class},"init");
if(_8e){
_cache={};
_name=objj_msgSend(_90,"decodeObjectForKey:","name");
_values=objj_msgSend(CPDictionary,"dictionary");
if(objj_msgSend(_90,"containsValueForKey:","value")){
var _91=CPThemeStateNormal;
if(objj_msgSend(_90,"containsValueForKey:","state")){
_91=CPThemeState(objj_msgSend(_90,"decodeObjectForKey:","state"));
}
objj_msgSend(_values,"setObject:forKey:",objj_msgSend(_90,"decodeObjectForKey:","value"),_91);
}else{
var _92=objj_msgSend(_90,"decodeObjectForKey:","values"),_93=objj_msgSend(_92,"allKeys"),_94=_93.length;
while(_94--){
var key=_93[_94];
objj_msgSend(_values,"setObject:forKey:",objj_msgSend(_92,"objectForKey:",key),CPThemeState(key));
}
}
}
return _8e;
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_95,_96,_97){
with(_95){
objj_msgSend(_97,"encodeObject:forKey:",_name,"name");
var _98=objj_msgSend(_values,"allKeys"),_99=_98.length;
if(_99===1){
var _9a=_98[0];
if(Number(_9a)!==CPThemeStateNormal){
objj_msgSend(_97,"encodeObject:forKey:",CPThemeStateName(Number(_9a)),"state");
}
objj_msgSend(_97,"encodeObject:forKey:",objj_msgSend(_values,"objectForKey:",_9a),"value");
}else{
var _9b=objj_msgSend(CPDictionary,"dictionary");
while(_99--){
var key=_98[_99];
objj_msgSend(_9b,"setObject:forKey:",objj_msgSend(_values,"objectForKey:",key),CPThemeStateName(Number(key)));
}
objj_msgSend(_97,"encodeObject:forKey:",_9b,"values");
}
}
})]);
var _85=[0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4,1,2,2,3,2,3,3,4,2,3,3,4,3,4,4,5,1,2,2,3,2,3,3,4,2,3,3,4,3,4,4,5,2,3,3,4,3,4,4,5,3,4,4,5,4,5,5,6];
var _86=function(_9c){
var _9d=0,_9e=_9c;
while(_9c){
++_9d;
_9c&=(_9c-1);
...
_86.displayName="numberOfOnes";
CPThemeAttributeEncode=function(_9f,_a0){
var _a1=_a0._values,_a2=objj_msgSend(_a1,"count"),key="$a"+objj_msgSend(_a0,"name");
if(_a2===1){
var _a3=objj_msgSend(_a1,"allKeys")[0];
if(Number(_a3)===0){
objj_msgSend(_9f,"encodeObject:forKey:",objj_msgSend(_a1,"objectForKey:",_a3),key);
return YES;
}
}
if(_a2>=1){
objj_msgSend(_9f,"encodeObject:forKey:",_a0,key);
return YES;
}
return NO;
};
CPThemeAttributeDecode=function(_a4,_a5,_a6,_a7,_a8){
var key="$a"+_a5;
if(!objj_msgSend(_a4,"containsValueForKey:",key)){
var _a9=objj_msgSend(objj_msgSend(_CPThemeAttribute,"alloc"),"initWithName:defaultValue:",_a5,_a6);
}else{
var _a9=objj_msgSend(_a4,"decodeObjectForKey:",key);
if(!_a9.isa||!objj_msgSend(_a9,"isKindOfClass:",objj_msgSend(_CPThemeAttribute,"class"))){
var _aa=objj_msgSend(objj_msgSend(_CPThemeAttribute,"alloc"),"initWithName:defaultValue:",_a5,_a6);
objj_msgSend(_aa,"setValue:",_a9);
_a9=_aa;
}
}
if(_a7&&_a8){
objj_msgSend(_a9,"setParentAttribute:",objj_msgSend(_a7,"attributeWithName:forClass:",_a5,_a8));
}
return _a9;
};
p;19;CPKeyValueBinding.jt;13945;@STATIC;1.0;I;21;Foundation/CPObject.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;31;Foundation/CPValueTransformer.jt;13808;
objj_executeFile("Foundation/CPObject.j",NO);
objj_executeFile("Foundation/CPArray.j",NO);
objj_executeFile("Foundation/CPDictionary.j",NO);
...
class_addIvars(_5,[new objj_ivar("_info"),new objj_ivar("_source"),new objj_ivar("_suppressedNotifications")]);
objj_registerClassPair(_5);
...
var _24=_suppressedNotifications[objj_msgSend(_21,"UID")];
if(_24&&_24[_20]){
return;
}
objj_msgSend(_1e,"setValueFor:",_23);
}
}),new objj_method(sel_getUid("transformValue:withOptions:"),function(_25,_26,_27,_28){
with(_25){
var _29=objj_msgSend(_28,"objectForKey:",CPValueTransformerNameBindingOption),_2a;
if(_29){
_2a=objj_msgSend(CPValueTransformer,"valueTransformerForName:",_29);
if(!_2a){
var _2b=CPClassFromString(_29);
if(_2b){
_2a=objj_msgSend(objj_msgSend(_2b,"alloc"),"init");
objj_msgSend(_2b,"setValueTransformer:forName:",_2a,_29);
}
}
}else{
_2a=objj_msgSend(_28,"objectForKey:",CPValueTransformerBindingOption);
}
if(_2a){
_27=objj_msgSend(_2a,"transformedValue:",_27);
}
if(_27===undefined||_27===nil||_27===objj_msgSend(CPNull,"null")){
_27=objj_msgSend(_28,"objectForKey:",CPNullPlaceholderBindingOption)||nil;
}
return _27;
}
...
}),new objj_method(sel_getUid("handlesContentAsCompoundValue"),function(_35,_36){
with(_35){
var _37=objj_msgSend(_info,"objectForKey:",CPOptionsKey);
return objj_msgSend(objj_msgSend(_37,"objectForKey:",CPHandlesContentAsCompoundValueBindingOption),"boolValue");
}
}),new objj_method(sel_getUid("suppressSpecificNotificationFromObject:keyPath:"),function(_38,_39,_3a,_3b){
with(_38){
if(!_3a){
return;
}
var uid=objj_msgSend(_3a,"UID"),_3c=_suppressedNotifications[uid];
if(!_3c){
_suppressedNotifications[uid]=_3c={};
}
_3c[_3b]=YES;
}
}),new objj_method(sel_getUid("unsuppressSpecificNotificationFromObject:keyPath:"),function(_3d,_3e,_3f,_40){
with(_3d){
if(!_3f){
return;
}
var uid=objj_msgSend(_3f,"UID"),_41=_suppressedNotifications[uid];
if(!_41){
return;
}
delete _41[_40];
...
class_addMethods(_6,[new objj_method(sel_getUid("exposeBinding:forClass:"),function(_42,_43,_44,_45){
with(_42){
var _46=objj_msgSend(_1,"objectForKey:",objj_msgSend(_45,"UID"));
if(!_46){
_46=[];
objj_msgSend(_1,"setObject:forKey:",_46,objj_msgSend(_45,"UID"));
}
_46.push(_44);
}
}),new objj_method(sel_getUid("exposedBindingsForClass:"),function(_47,_48,_49){
with(_47){
return objj_msgSend(objj_msgSend(_1,"objectForKey:",objj_msgSend(_49,"UID")),"copy");
}
}),new objj_method(sel_getUid("getBinding:forObject:"),function(_4a,_4b,_4c,_4d){
with(_4a){
return objj_msgSend(objj_msgSend(_2,"objectForKey:",objj_msgSend(_4d,"UID")),"objectForKey:",_4c);
}
}),new objj_method(sel_getUid("infoForBinding:forObject:"),function(_4e,_4f,_50,_51){
with(_4e){
var _52=objj_msgSend(_4e,"getBinding:forObject:",_50,_51);
if(_52){
return _52._info;
}
return nil;
}
}),new objj_method(sel_getUid("allBindingsForObject:"),function(_53,_54,_55){
with(_53){
return objj_msgSend(_2,"objectForKey:",objj_msgSend(_55,"UID"));
}
}),new objj_method(sel_getUid("unbind:forObject:"),function(_56,_57,_58,_59){
with(_56){
var _5a=objj_msgSend(_2,"objectForKey:",objj_msgSend(_59,"UID"));
if(!_5a){
return;
}
var _5b=objj_msgSend(_5a,"objectForKey:",_58);
if(!_5b){
return;
}
var _5c=_5b._info,_5d=objj_msgSend(_5c,"objectForKey:",CPObservedObjectKey),_5e=objj_msgSend(_5c,"objectForKey:",CPObservedKeyPathKey);
objj_msgSend(_5d,"removeObserver:forKeyPath:",_5b,_5e);
objj_msgSend(_5a,"removeObjectForKey:",_58);
}
}),new objj_method(sel_getUid("unbindAllForObject:"),function(_5f,_60,_61){
with(_5f){
var _62=objj_msgSend(_2,"objectForKey:",objj_msgSend(_61,"UID"));
if(!_62){
return;
}
var _63=objj_msgSend(_62,"allKeys"),_64=_63.length;
while(_64--){
objj_msgSend(_61,"unbind:",objj_msgSend(_62,"objectForKey:",_63[_64]));
}
objj_msgSend(_2,"removeObjectForKey:",objj_msgSend(_61,"UID"));
}
})]);
...
var _6=_5.isa;
class_addMethods(_5,[new objj_method(sel_getUid("exposedBindings"),function(_65,_66){
with(_65){
var _67=[],_68=objj_msgSend(_65,"class");
while(_68){
var _69=objj_msgSend(CPBinder,"exposedBindingsForClass:",_68);
if(_69){
objj_msgSend(_67,"addObjectsFromArray:",_69);
}
_68=objj_msgSend(_68,"superclass");
}
return _67;
}
}),new objj_method(sel_getUid("valueClassForBinding:"),function(_6a,_6b,_6c){
with(_6a){
return objj_msgSend(CPString,"class");
}
}),new objj_method(sel_getUid("bind:toObject:withKeyPath:options:"),function(_6d,_6e,_6f,_70,_71,_72){
with(_6d){
if(!_70||!_71){
return CPLog.error("Invalid object or path on "+_6d+" for "+_6f);
}
var _73=objj_msgSend(objj_msgSend(_6d,"class"),"_binderClassForBinding:",_6f);
objj_msgSend(_6d,"unbind:",_6f);
objj_msgSend(objj_msgSend(_73,"alloc"),"initWithBinding:name:to:keyPath:options:from:",objj_msgSend(_6d,"_replacementKeyPathForBinding:",_6f),_6f,_70,_71,_72,_6d);
}
}),new objj_method(sel_getUid("infoForBinding:"),function(_74,_75,_76){
with(_74){
return objj_msgSend(CPBinder,"infoForBinding:forObject:",_76,_74);
}
}),new objj_method(sel_getUid("unbind:"),function(_77,_78,_79){
with(_77){
var _7a=objj_msgSend(objj_msgSend(_77,"class"),"_binderClassForBinding:",_79);
objj_msgSend(_7a,"unbind:forObject:",_79,_77);
}
}),new objj_method(sel_getUid("_replacementKeyPathForBinding:"),function(_7b,_7c,_7d){
with(_7b){
return _7d;
}
})]);
class_addMethods(_6,[new objj_method(sel_getUid("exposeBinding:"),function(_7e,_7f,_80){
with(_7e){
objj_msgSend(CPBinder,"exposeBinding:forClass:",_80,objj_msgSend(_7e,"class"));
}
}),new objj_method(sel_getUid("_binderClassForBinding:"),function(_81,_82,_83){
with(_81){
...
objj_registerClassPair(_5);
class_addMethods(_5,[new objj_method(sel_getUid("setValueFor:"),function(_84,_85,_86){
with(_84){
objj_msgSendSuper({receiver:_84,super_class:objj_getClass("_CPValueBinder").super_class},"setValueFor:","objectValue");
}
}),new objj_method(sel_getUid("reverseSetValueFor:"),function(_87,_88,_89){
with(_87){
objj_msgSendSuper({receiver:_87,super_class:objj_getClass("_CPValueBinder").super_class},"reverseSetValueFor:","objectValue");
}
})]);
var _5=objj_allocateClassPair(CPBinder,"_CPKeyValueOrBinding"),_6=_5.isa;
objj_registerClassPair(_5);
class_addMethods(_5,[new objj_method(sel_getUid("setValueFor:"),function(_8a,_8b,_8c){
with(_8a){
var _8d=objj_msgSend(_2,"valueForKey:",objj_msgSend(_source,"UID"));
if(!_8d){
return;
}
objj_msgSend(_source,"setValue:forKey:",_8e(_8c,_8d,_4),_8c);
}
}),new objj_method(sel_getUid("observeValueForKeyPath:ofObject:change:context:"),function(_8f,_90,_91,_92,_93,_94){
with(_8f){
objj_msgSend(_8f,"setValueFor:",_94);
}
})]);
var _5=objj_allocateClassPair(CPBinder,"_CPKeyValueAndBinding"),_6=_5.isa;
objj_registerClassPair(_5);
class_addMethods(_5,[new objj_method(sel_getUid("setValueFor:"),function(_95,_96,_97){
with(_95){
var _98=objj_msgSend(_2,"objectForKey:",objj_msgSend(_source,"UID"));
if(!_98){
return;
}
objj_msgSend(_source,"setValue:forKey:",_8e(_97,_98,_3),_97);
}
}),new objj_method(sel_getUid("observeValueForKeyPath:ofObject:change:context:"),function(_99,_9a,_9b,_9c,_9d,_9e){
with(_99){
objj_msgSend(_99,"setValueFor:",_9e);
}
})]);
var _8e=_8e=function(key,_9f,_a0){
var _a1=key,_a2,_a3=1;
while(_a2=objj_msgSend(_9f,"objectForKey:",_a1)){
var _a4=_a2._info,_a5=objj_msgSend(_a4,"objectForKey:",CPObservedObjectKey),_a6=objj_msgSend(_a4,"objectForKey:",CPObservedKeyPathKey),_a7=objj_msgSend(_a4,"objectForKey:",CPOptionsKey);
var _a8=objj_msgSend(_a2,"transformValue:withOptions:",objj_msgSend(_a5,"valueForKeyPath:",_a6),_a7);
if(_a8==_a0){
return _a0;
}
_a1=objj_msgSend(CPString,"stringWithFormat:","%@%i",key,++_a3);
}
return !_a0;
};
var _a9=_a9=function(_aa,_ab,_ac){
var _ad=objj_msgSend(_ac,"objectForKey:",_aa),_ae=_ad._info,_af=objj_msgSend(_ae,"objectForKey:",CPObservedObjectKey),_b0=objj_msgSend(_ae,"objectForKey:",CPObservedKeyPathKey),_b1=objj_msgSend(_ae,"objectForKey:",CPOptionsKey),_b2=objj_msgSend(_af,"valueForKeyPath:",_b0),_b3=objj_msgSend(_b1,"objectForKey:",CPSelectorNameBindingOption);
if(!_b2||!_b3){
return;
}
var _b4=objj_msgSend(CPInvocation,"invocationWithMethodSignature:",objj_msgSend(_b2,"methodSignatureForSelector:",_b3));
objj_msgSend(_b4,"setSelector:",_b3);
var _b5=_ab,_b6=1;
while(_ad=objj_msgSend(_ac,"objectForKey:",_b5)){
_ae=_ad._info;
_b0=objj_msgSend(_ae,"objectForKey:",CPObserverKeyPathKey);
_af=objj_msgSend(objj_msgSend(_ae,"objectForKey:",CPObservedObjectKey),"valueForKeyPath:",_b0);
if(_af){
objj_msgSend(_b4,"setArgument:atIndex:",_af,++_b6);
}
_b5=objj_msgSend(CPString,"stringWithFormat:","%@%i",_ab,_b6);
}
objj_msgSend(_b4,"invoke");
};
...
CPIsControllerMarker=function(_b7){
return _b7===CPMultipleValuesMarker||_b7===CPNoSelectionMarker||_b7===CPNotApplicableMarker||_b7===CPNullMarker;
};
p;10;CPButton.jt;21923;@STATIC;1.0;i;21;_CPImageAndTextView.ji;12;CGGeometry.ji;11;CPControl.ji;17;CPStringDrawing.ji;12;CPCheckBox.ji;9;CPRadio.jt;21792;
objj_executeFile("_CPImageAndTextView.j",YES);
objj_executeFile("CGGeometry.j",YES);
objj_executeFile("CPControl.j",YES);
objj_executeFile("CPStringDrawing.j",YES);
...
if(objj_msgSend(_ab,"containsValueForKey:",_a2)){
...
_contentView=objj_msgSend(objj_msgSend(CPClipView,"alloc"),"initWithFrame:",objj_msgSend(_6,"_insetBounds"));
objj_msgSend(_6,"addSubview:",_contentView);
_headerClipView=objj_msgSend(objj_msgSend(CPClipView,"alloc"),"init");
objj_msgSend(_6,"addSubview:",_headerClipView);
_bottomCornerView=objj_msgSend(objj_msgSend(CPView,"alloc"),"init");
objj_msgSend(_6,"addSubview:",_bottomCornerView);
objj_msgSend(_6,"setHasVerticalScroller:",YES);
objj_msgSend(_6,"setHasHorizontalScroller:",YES);
_delegate=nil;
_scrollTimer=nil;
...
}),new objj_method(sel_getUid("_insetBounds"),function(_e,_f){
with(_e){
return objj_msgSend(objj_msgSend(_e,"class"),"_insetBounds:borderType:",objj_msgSend(_e,"bounds"),_borderType);
}
}),new objj_method(sel_getUid("contentSize"),function(_10,_11){
with(_10){
return objj_msgSend(_contentView,"frame").size;
}
}),new objj_method(sel_getUid("documentView"),function(_12,_13){
with(_12){
return objj_msgSend(_contentView,"documentView");
}
}),new objj_method(sel_getUid("setContentView:"),function(_14,_15,_16){
with(_14){
if(_contentView===_16||!_16){
return;
}
var _17=objj_msgSend(_16,"documentView");
if(_17){
objj_msgSend(_17,"removeFromSuperview");
}
objj_msgSend(_contentView,"removeFromSuperview");
_contentView=_16;
objj_msgSend(_contentView,"setDocumentView:",_17);
objj_msgSend(_14,"addSubview:",_contentView);
objj_msgSend(_14,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("contentView"),function(_18,_19){
with(_18){
return _contentView;
}
}),new objj_method(sel_getUid("setDocumentView:"),function(_1a,_1b,_1c){
with(_1a){
objj_msgSend(_contentView,"setDocumentView:",_1c);
objj_msgSend(_1a,"_updateCornerAndHeaderView");
objj_msgSend(_1a,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("reflectScrolledClipView:"),function(_1d,_1e,_1f){
with(_1d){
if(_contentView!==_1f){
return;
}
...
++_recursionCount;
var _20=objj_msgSend(_1d,"documentView");
if(!_20){
...
objj_msgSend(_contentView,"setFrame:",objj_msgSend(_1d,"_insetBounds"));
objj_msgSend(_headerClipView,"setFrame:",{origin:{x:0,y:0},size:{width:0,height:0}});
--_recursionCount;
return;
}
var _21=objj_msgSend(_20,"frame"),_22=objj_msgSend(_1d,"_insetBounds"),_23=objj_msgSend(_1d,"_headerClipViewFrame"),_24=(_23.size.height);
_22.origin.y+=_24;
_22.size.height-=_24;
var _25={width:(_21.size.width)-(_22.size.width),height:(_21.size.height)-(_22.size.height)},_26=(objj_msgSend(_verticalScroller,"frame").size.width),_27=(objj_msgSend(_horizontalScroller,"frame").size.height),_28=_25.height>0,_29=_25.width>0,_2a=_hasVerticalScroller&&(!_autohidesScrollers||_28),_2b=_hasHorizontalScroller&&(!_autohidesScrollers||_29);
if(_2a){
_25.width+=_26;
_29=_25.width>0;
_2b=_hasHorizontalScroller&&(!_autohidesScrollers||_29);
}
if(_2b){
_25.height+=_27;
_28=_25.height>0;
_2a=_hasVerticalScroller&&(!_autohidesScrollers||_28);
}
objj_msgSend(_verticalScroller,"setHidden:",!_2a);
objj_msgSend(_verticalScroller,"setEnabled:",_28);
objj_msgSend(_horizontalScroller,"setHidden:",!_2b);
objj_msgSend(_horizontalScroller,"setEnabled:",_29);
if(_2a){
_22.size.width-=_26;
}
if(_2b){
...
var _2c=objj_msgSend(_contentView,"bounds").origin,_2d=!objj_msgSend(_verticalScroller,"isHidden"),_2e=!objj_msgSend(_horizontalScroller,"isHidden");
if(_2a){
var _2f=MAX((_22.origin.y),MAX((objj_msgSend(_1d,"_cornerViewFrame").origin.y+objj_msgSend(_1d,"_cornerViewFrame").size.height),(_23.origin.y+_23.size.height)));
var _30=(_22.origin.y+_22.size.height)-_2f;
objj_msgSend(_verticalScroller,"setFloatValue:",(_25.height<=0)?0:_2c.y/_25.height);
objj_msgSend(_verticalScroller,"setKnobProportion:",(_22.size.height)/(_21.size.height));
objj_msgSend(_verticalScroller,"setFrame:",{origin:{x:(_22.origin.x+_22.size.width),y:_2f},size:{width:_26,height:_30}});
}else{
if(_2d){
...
if(_2b){
objj_msgSend(_horizontalScroller,"setFloatValue:",(_25.width<=0)?0:_2c.x/_25.width);
objj_msgSend(_horizontalScroller,"setKnobProportion:",(_22.size.width)/(_21.size.width));
objj_msgSend(_horizontalScroller,"setFrame:",{origin:{x:(_22.origin.x),y:(_22.origin.y+_22.size.height)},size:{width:(_22.size.width),height:_27}});
}else{
if(_2e){
...
objj_msgSend(_contentView,"setFrame:",_22);
objj_msgSend(_headerClipView,"setFrame:",_23);
objj_msgSend(objj_msgSend(_headerClipView,"documentView"),"setNeedsDisplay:",YES);
objj_msgSend(_cornerView,"setFrame:",objj_msgSend(_1d,"_cornerViewFrame"));
objj_msgSend(objj_msgSend(_1d,"bottomCornerView"),"setFrame:",objj_msgSend(_1d,"_bottomCornerViewFrame"));
objj_msgSend(objj_msgSend(_1d,"bottomCornerView"),"setBackgroundColor:",objj_msgSend(_1d,"currentValueForThemeAttribute:","bottom-corner-color"));
--_recursionCount;
}
}),new objj_method(sel_getUid("setBorderType:"),function(_31,_32,_33){
with(_31){
if(_borderType==_33){
return;
}
...
}),new objj_method(sel_getUid("borderType"),function(_34,_35){
with(_34){
return _borderType;
}
}),new objj_method(sel_getUid("setHorizontalScroller:"),function(_36,_37,_38){
with(_36){
if(_horizontalScroller===_38){
return;
}
...
_horizontalScroller=_38;
objj_msgSend(_horizontalScroller,"setTarget:",_36);
objj_msgSend(_horizontalScroller,"setAction:",sel_getUid("_horizontalScrollerDidScroll:"));
objj_msgSend(_36,"addSubview:",_horizontalScroller);
objj_msgSend(_36,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("horizontalScroller"),function(_39,_3a){
with(_39){
return _horizontalScroller;
}
}),new objj_method(sel_getUid("setHasHorizontalScroller:"),function(_3b,_3c,_3d){
with(_3b){
if(_hasHorizontalScroller===_3d){
return;
}
_hasHorizontalScroller=_3d;
if(_hasHorizontalScroller&&!_horizontalScroller){
var _3e=objj_msgSend(_3b,"_insetBounds");
objj_msgSend(_3b,"setHorizontalScroller:",objj_msgSend(objj_msgSend(CPScroller,"alloc"),"initWithFrame:",CGRectMake(0,0,MAX((_3e.size.width),objj_msgSend(CPScroller,"scrollerWidth")+1),objj_msgSend(CPScroller,"scrollerWidth"))));
objj_msgSend(objj_msgSend(_3b,"horizontalScroller"),"setFrameSize:",CGSizeMake((_3e.size.width),objj_msgSend(CPScroller,"scrollerWidth")));
}
objj_msgSend(_3b,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("hasHorizontalScroller"),function(_3f,_40){
with(_3f){
return _hasHorizontalScroller;
}
}),new objj_method(sel_getUid("setVerticalScroller:"),function(_41,_42,_43){
with(_41){
if(_verticalScroller===_43){
return;
}
...
_verticalScroller=_43;
objj_msgSend(_verticalScroller,"setTarget:",_41);
objj_msgSend(_verticalScroller,"setAction:",sel_getUid("_verticalScrollerDidScroll:"));
objj_msgSend(_41,"addSubview:",_verticalScroller);
objj_msgSend(_41,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("verticalScroller"),function(_44,_45){
with(_44){
return _verticalScroller;
}
}),new objj_method(sel_getUid("setHasVerticalScroller:"),function(_46,_47,_48){
with(_46){
if(_hasVerticalScroller===_48){
return;
}
_hasVerticalScroller=_48;
if(_hasVerticalScroller&&!_verticalScroller){
var _49=objj_msgSend(_46,"_insetBounds");
objj_msgSend(_46,"setVerticalScroller:",objj_msgSend(objj_msgSend(CPScroller,"alloc"),"initWithFrame:",{origin:{x:0,y:0},size:{width:objj_msgSend(CPScroller,"scrollerWidth"),height:MAX((_49.size.height),objj_msgSend(CPScroller,"scrollerWidth")+1)}}));
objj_msgSend(objj_msgSend(_46,"verticalScroller"),"setFrameSize:",CGSizeMake(objj_msgSend(CPScroller,"scrollerWidth"),(_49.size.height)));
}
objj_msgSend(_46,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("hasVerticalScroller"),function(_4a,_4b){
with(_4a){
return _hasVerticalScroller;
}
}),new objj_method(sel_getUid("setAutohidesScrollers:"),function(_4c,_4d,_4e){
with(_4c){
if(_autohidesScrollers==_4e){
return;
}
_autohidesScrollers=_4e;
objj_msgSend(_4c,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("autohidesScrollers"),function(_4f,_50){
with(_4f){
return _autohidesScrollers;
}
}),new objj_method(sel_getUid("_updateCornerAndHeaderView"),function(_51,_52){
with(_51){
var _53=objj_msgSend(_51,"documentView"),_54=objj_msgSend(_51,"_headerView"),_55=objj_msgSend(_53,"respondsToSelector:",sel_getUid("headerView"))?objj_msgSend(_53,"headerView"):nil;
if(_54!==_55){
objj_msgSend(_54,"removeFromSuperview");
objj_msgSend(_headerClipView,"setDocumentView:",_55);
}
var _56=objj_msgSend(_53,"respondsToSelector:",sel_getUid("cornerView"))?objj_msgSend(_53,"cornerView"):nil;
if(_cornerView!==_56){
objj_msgSend(_cornerView,"removeFromSuperview");
_cornerView=_56;
if(_cornerView){
objj_msgSend(_51,"addSubview:",_cornerView);
}
}
objj_msgSend(_51,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("_headerView"),function(_57,_58){
with(_57){
return objj_msgSend(_headerClipView,"documentView");
}
}),new objj_method(sel_getUid("_cornerViewFrame"),function(_59,_5a){
with(_59){
if(!_cornerView){
return {origin:{x:0,y:0},size:{width:0,height:0}};
}
var _5b=objj_msgSend(_59,"_insetBounds"),_5c=objj_msgSend(_cornerView,"frame");
_5c.origin.x=(_5b.origin.x+_5b.size.width)-(_5c.size.width);
_5c.origin.y=(_5b.origin.y);
return _5c;
}
}),new objj_method(sel_getUid("_headerClipViewFrame"),function(_5d,_5e){
with(_5d){
var _5f=objj_msgSend(_5d,"_headerView");
if(!_5f){
return {origin:{x:0,y:0},size:{width:0,height:0}};
}
var _60=objj_msgSend(_5d,"_insetBounds");
_60.size.height=(objj_msgSend(_5f,"frame").size.height);
_60.size.width-=(objj_msgSend(_5d,"_cornerViewFrame").size.width);
return _60;
}
}),new objj_method(sel_getUid("_bottomCornerViewFrame"),function(_61,_62){
with(_61){
if(objj_msgSend(objj_msgSend(_61,"horizontalScroller"),"isHidden")||objj_msgSend(objj_msgSend(_61,"verticalScroller"),"isHidden")){
return CGRectMakeZero();
}
var _63=objj_msgSend(objj_msgSend(_61,"verticalScroller"),"frame"),_64=CGRectMakeZero();
_64.origin.x=CGRectGetMinX(_63);
_64.origin.y=CGRectGetMaxY(_63);
_64.size.width=objj_msgSend(CPScroller,"scrollerWidth");
_64.size.height=objj_msgSend(CPScroller,"scrollerWidth");
return _64;
}
}),new objj_method(sel_getUid("setBottomCornerView:"),function(_65,_66,_67){
with(_65){
if(_bottomCornerView===_67){
return;
}
objj_msgSend(_bottomCornerView,"removeFromSuperview");
objj_msgSend(_67,"setFrame:",objj_msgSend(_65,"_bottomCornerViewFrame"));
objj_msgSend(_65,"addSubview:",_67);
_bottomCornerView=_67;
objj_msgSend(_65,"_updateCornerAndHeaderView");
}
}),new objj_method(sel_getUid("bottomCornerView"),function(_68,_69){
with(_68){
return _bottomCornerView;
}
}),new objj_method(sel_getUid("_verticalScrollerDidScroll:"),function(_6a,_6b,_6c){
with(_6a){
var _6d=objj_msgSend(_6c,"floatValue"),_6e=objj_msgSend(objj_msgSend(_contentView,"documentView"),"frame"),_6f=objj_msgSend(_contentView,"bounds");
switch(objj_msgSend(_verticalScroller,"hitPart")){
case CPScrollerDecrementLine:
_6f.origin.y-=_verticalLineScroll;
break;
case CPScrollerIncrementLine:
_6f.origin.y+=_verticalLineScroll;
break;
case CPScrollerDecrementPage:
_6f.origin.y-=(_6f.size.height)-_verticalPageScroll;
break;
...
case CPScrollerKnob:
default:
_6f.origin.y=ROUND(_6d*((_6e.size.height)-(_6f.size.height)));
}
objj_msgSend(_6a,"_sendDelegateMessages");
objj_msgSend(_contentView,"scrollToPoint:",_6f.origin);
}
}),new objj_method(sel_getUid("_horizontalScrollerDidScroll:"),function(_70,_71,_72){
with(_70){
var _73=objj_msgSend(_72,"floatValue"),_74=objj_msgSend(objj_msgSend(_70,"documentView"),"frame"),_75=objj_msgSend(_contentView,"bounds");
...
break;
case CPScrollerDecrementPage:
_75.origin.x-=(_75.size.width)-_horizontalPageScroll;
break;
case CPScrollerIncrementPage:
_75.origin.x+=(_75.size.width)-_horizontalPageScroll;
break;
...
case CPScrollerKnob:
default:
_75.origin.x=ROUND(_73*((_74.size.width)-(_75.size.width)));
}
objj_msgSend(_70,"_sendDelegateMessages");
objj_msgSend(_contentView,"scrollToPoint:",_75.origin);
objj_msgSend(_headerClipView,"scrollToPoint:",CGPointMake(_75.origin.x,0));
}
}),new objj_method(sel_getUid("tile"),function(_76,_77){
with(_76){
}
}),new objj_method(sel_getUid("resizeSubviewsWithOldSize:"),function(_78,_79,_7a){
with(_78){
objj_msgSend(_78,"reflectScrolledClipView:",_contentView);
}
}),new objj_method(sel_getUid("setLineScroll:"),function(_7b,_7c,_7d){
with(_7b){
objj_msgSend(_7b,"setHorizontalLineScroll:",_7d);
objj_msgSend(_7b,"setVerticalLineScroll:",_7d);
}
}),new objj_method(sel_getUid("lineScroll"),function(_7e,_7f){
with(_7e){
return objj_msgSend(_7e,"horizontalLineScroll");
}
}),new objj_method(sel_getUid("setHorizontalLineScroll:"),function(_80,_81,_82){
with(_80){
_horizontalLineScroll=_82;
}
}),new objj_method(sel_getUid("horizontalLineScroll"),function(_83,_84){
with(_83){
return _horizontalLineScroll;
}
}),new objj_method(sel_getUid("setVerticalLineScroll:"),function(_85,_86,_87){
with(_85){
_verticalLineScroll=_87;
}
}),new objj_method(sel_getUid("verticalLineScroll"),function(_88,_89){
with(_88){
return _verticalLineScroll;
}
}),new objj_method(sel_getUid("setPageScroll:"),function(_8a,_8b,_8c){
with(_8a){
objj_msgSend(_8a,"setHorizontalPageScroll:",_8c);
objj_msgSend(_8a,"setVerticalPageScroll:",_8c);
}
}),new objj_method(sel_getUid("pageScroll"),function(_8d,_8e){
with(_8d){
return objj_msgSend(_8d,"horizontalPageScroll");
}
}),new objj_method(sel_getUid("setHorizontalPageScroll:"),function(_8f,_90,_91){
with(_8f){
_horizontalPageScroll=_91;
}
}),new objj_method(sel_getUid("horizontalPageScroll"),function(_92,_93){
with(_92){
return _horizontalPageScroll;
}
}),new objj_method(sel_getUid("setVerticalPageScroll:"),function(_94,_95,_96){
with(_94){
_verticalPageScroll=_96;
}
}),new objj_method(sel_getUid("verticalPageScroll"),function(_97,_98){
with(_97){
return _verticalPageScroll;
}
}),new objj_method(sel_getUid("drawRect:"),function(_99,_9a,_9b){
with(_99){
objj_msgSendSuper({receiver:_99,super_class:objj_getClass("CPScrollView").super_class},"drawRect:",_9b);
if(_borderType==CPNoBorder){
return;
}
var _9c=objj_msgSend(_99,"bounds"),_9d=objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort");
CGContextSetLineWidth(_9d,1);
switch(_borderType){
case CPLineBorder:
CGContextSetStrokeColor(_9d,objj_msgSend(_99,"currentValueForThemeAttribute:","border-color"));
CGContextStrokeRect(_9d,{origin:{x:_9c.origin.x+0.5,y:_9c.origin.y+0.5},size:{width:_9c.size.width-2*0.5,height:_9c.size.height-2*0.5}});
break;
case CPBezelBorder:
objj_msgSend(_99,"_drawGrayBezelInContext:bounds:",_9d,_9c);
break;
case CPGrooveBorder:
objj_msgSend(_99,"_drawGrooveInContext:bounds:",_9d,_9c);
break;
default:
break;
}
}
}),new objj_method(sel_getUid("_drawGrayBezelInContext:bounds:"),function(_9e,_9f,_a0,_a1){
with(_9e){
CGContextBeginPath(_a0);
CGContextSetStrokeColor(_a0,objj_msgSend(CPColor,"colorWithWhite:alpha:",142/255,1));
var y=(_a1.origin.y)+0.5;
CGContextMoveToPoint(_a0,(_a1.origin.x),y);
CGContextAddLineToPoint(_a0,(_a1.origin.x)+1,y);
CGContextStrokePath(_a0);
CGContextBeginPath(_a0);
CGContextSetStrokeColor(_a0,objj_msgSend(CPColor,"colorWithWhite:alpha:",192/255,1));
CGContextMoveToPoint(_a0,(_a1.origin.x)+1,y);
CGContextAddLineToPoint(_a0,(_a1.origin.x+_a1.size.width)-1,y);
CGContextStrokePath(_a0);
CGContextBeginPath(_a0);
CGContextSetStrokeColor(_a0,objj_msgSend(CPColor,"colorWithWhite:alpha:",142/255,1));
CGContextMoveToPoint(_a0,(_a1.origin.x+_a1.size.width)-1,y);
CGContextAddLineToPoint(_a0,(_a1.origin.x+_a1.size.width),y);
CGContextStrokePath(_a0);
CGContextBeginPath(_a0);
CGContextSetStrokeColor(_a0,objj_msgSend(CPColor,"colorWithWhite:alpha:",190/255,1));
var x=(_a1.origin.x+_a1.size.width)-0.5;
CGContextMoveToPoint(_a0,x,(_a1.origin.y)+1);
CGContextAddLineToPoint(_a0,x,(_a1.origin.y+_a1.size.height));
CGContextMoveToPoint(_a0,x-0.5,(_a1.origin.y+_a1.size.height)-0.5);
CGContextAddLineToPoint(_a0,(_a1.origin.x),(_a1.origin.y+_a1.size.height)-0.5);
x=(_a1.origin.x)+0.5;
CGContextMoveToPoint(_a0,x,(_a1.origin.y+_a1.size.height));
CGContextAddLineToPoint(_a0,x,(_a1.origin.y)+1);
CGContextStrokePath(_a0);
}
}),new objj_method(sel_getUid("_drawGrooveInContext:bounds:"),function(_a2,_a3,_a4,_a5){
with(_a2){
CGContextBeginPath(_a4);
CGContextSetStrokeColor(_a4,objj_msgSend(CPColor,"colorWithWhite:alpha:",159/255,1));
var y=(_a5.origin.y)+0.5;
CGContextMoveToPoint(_a4,(_a5.origin.x),y);
CGContextAddLineToPoint(_a4,(_a5.origin.x+_a5.size.width),y);
var x=(_a5.origin.x+_a5.size.width)-1.5;
CGContextMoveToPoint(_a4,x,(_a5.origin.y)+2);
CGContextAddLineToPoint(_a4,x,(_a5.origin.y+_a5.size.height)-1);
y=(_a5.origin.y+_a5.size.height)-1.5;
CGContextMoveToPoint(_a4,(_a5.origin.x+_a5.size.width)-1,y);
CGContextAddLineToPoint(_a4,(_a5.origin.x)+2,y);
x=(_a5.origin.x)+0.5;
CGContextMoveToPoint(_a4,x,(_a5.origin.y+_a5.size.height));
CGContextAddLineToPoint(_a4,x,(_a5.origin.y));
CGContextStrokePath(_a4);
CGContextBeginPath(_a4);
CGContextSetStrokeColor(_a4,objj_msgSend(CPColor,"whiteColor"));
var _a6={origin:{x:_a5.origin.x+1,y:_a5.origin.y+1},size:{width:_a5.size.width,height:_a5.size.height}};
_a6.size.width-=1;
_a6.size.height-=1;
CGContextStrokeRect(_a4,{origin:{x:_a6.origin.x+0.5,y:_a6.origin.y+0.5},size:{width:_a6.size.width-2*0.5,height:_a6.size.height-2*0.5}});
CGContextBeginPath(_a4);
CGContextSetStrokeColor(_a4,objj_msgSend(CPColor,"colorWithWhite:alpha:",192/255,1));
y=(_a5.origin.y)+2.5;
CGContextMoveToPoint(_a4,(_a5.origin.x)+2,y);
CGContextAddLineToPoint(_a4,(_a5.origin.x+_a5.size.width)-2,y);
CGContextStrokePath(_a4);
}
}),new objj_method(sel_getUid("scrollWheel:"),function(_a7,_a8,_a9){
with(_a7){
objj_msgSend(_a7,"_respondToScrollWheelEventWithDeltaX:deltaY:",objj_msgSend(_a9,"deltaX"),objj_msgSend(_a9,"deltaY"));
}
}),new objj_method(sel_getUid("_respondToScrollWheelEventWithDeltaX:deltaY:"),function(_aa,_ab,_ac,_ad){
with(_aa){
var _ae=objj_msgSend(objj_msgSend(_aa,"documentView"),"frame"),_af=objj_msgSend(_contentView,"bounds"),_b0=objj_msgSend(_contentView,"frame"),_b1=objj_msgSend(_aa,"enclosingScrollView");
_af.origin.x=ROUND(_af.origin.x+_ac);
_af.origin.y=ROUND(_af.origin.y+_ad);
var _b2=objj_msgSend(_contentView,"constrainScrollPoint:",CGPointCreateCopy(_af.origin)),_b3=_af.origin.x-_b2.x,_b4=_af.origin.y-_b2.y;
objj_msgSend(_aa,"_sendDelegateMessages");
objj_msgSend(_contentView,"scrollToPoint:",_b2);
objj_msgSend(_headerClipView,"scrollToPoint:",CGPointMake(_b2.x,0));
if(_b3||_b4){
objj_msgSend(_b1,"_respondToScrollWheelEventWithDeltaX:deltaY:",_b3,_b4);
}
}
}),new objj_method(sel_getUid("scrollPageUp:"),function(_b5,_b6,_b7){
with(_b5){
var _b8=objj_msgSend(_contentView,"bounds");
objj_msgSend(_b5,"moveByOffset:",CGSizeMake(0,-((_b8.size.height)-_verticalPageScroll)));
}
}),new objj_method(sel_getUid("scrollPageDown:"),function(_b9,_ba,_bb){
with(_b9){
var _bc=objj_msgSend(_contentView,"bounds");
objj_msgSend(_b9,"moveByOffset:",CGSizeMake(0,(_bc.size.height)-_verticalPageScroll));
}
}),new objj_method(sel_getUid("scrollToBeginningOfDocument:"),function(_bd,_be,_bf){
with(_bd){
objj_msgSend(_contentView,"scrollToPoint:",{x:0,y:0});
objj_msgSend(_headerClipView,"scrollToPoint:",{x:0,y:0});
}
}),new objj_method(sel_getUid("scrollToEndOfDocument:"),function(_c0,_c1,_c2){
with(_c0){
var _c3=objj_msgSend(_contentView,"bounds"),_c4=objj_msgSend(objj_msgSend(_c0,"documentView"),"frame"),_c5={x:0,y:(_c4.size.height)-(_c3.size.height)};
objj_msgSend(_contentView,"scrollToPoint:",_c5);
objj_msgSend(_headerClipView,"scrollToPoint:",{x:0,y:0});
}
}),new objj_method(sel_getUid("moveLeft:"),function(_c6,_c7,_c8){
with(_c6){
objj_msgSend(_c6,"moveByOffset:",CGSizeMake(-_horizontalLineScroll,0));
}
}),new objj_method(sel_getUid("moveRight:"),function(_c9,_ca,_cb){
with(_c9){
objj_msgSend(_c9,"moveByOffset:",CGSizeMake(_horizontalLineScroll,0));
}
}),new objj_method(sel_getUid("moveUp:"),function(_cc,_cd,_ce){
with(_cc){
objj_msgSend(_cc,"moveByOffset:",CGSizeMake(0,-_verticalLineScroll));
}
}),new objj_method(sel_getUid("moveDown:"),function(_cf,_d0,_d1){
with(_cf){
objj_msgSend(_cf,"moveByOffset:",CGSizeMake(0,_verticalLineScroll));
}
}),new objj_method(sel_getUid("moveByOffset:"),function(_d2,_d3,_d4){
with(_d2){
var _d5=objj_msgSend(objj_msgSend(_d2,"documentView"),"frame"),_d6=objj_msgSend(_contentView,"bounds");
_d6.origin.x+=_d4.width;
_d6.origin.y+=_d4.height;
objj_msgSend(_contentView,"scrollToPoint:",_d6.origin);
objj_msgSend(_headerClipView,"scrollToPoint:",CGPointMake(_d6.origin.x,0));
}
}),new objj_method(sel_getUid("_sendDelegateMessages"),function(_d7,_d8){
with(_d7){
if(_implementedDelegateMethods==0){
return;
}
if(!_scrollTimer){
objj_msgSend(_d7,"_scrollViewWillScroll");
_scrollTimer=objj_msgSend(CPTimer,"scheduledTimerWithTimeInterval:target:selector:userInfo:repeats:",_1,_d7,sel_getUid("_scrollViewDidScroll"),nil,YES);
}else{
objj_msgSend(_scrollTimer,"setFireDate:",objj_msgSend(CPDate,"dateWithTimeIntervalSinceNow:",_1));
}
}
}),new objj_method(sel_getUid("_scrollViewWillScroll"),function(_d9,_da){
with(_d9){
if(_implementedDelegateMethods&_2){
objj_msgSend(_delegate,"scrollViewWillScroll:",_d9);
}
}
}),new objj_method(sel_getUid("_scrollViewDidScroll"),function(_db,_dc){
with(_db){
objj_msgSend(_scrollTimer,"invalidate");
_scrollTimer=nil;
if(_implementedDelegateMethods&_3){
objj_msgSend(_delegate,"scrollViewDidScroll:",_db);
}
}
})]);
class_addMethods(_5,[new objj_method(sel_getUid("defaultThemeClass"),function(_dd,_de){
with(_dd){
return "scrollview";
}
}),new objj_method(sel_getUid("themeAttributes"),function(_df,_e0){
with(_df){
...
}),new objj_method(sel_getUid("contentSizeForFrameSize:hasHorizontalScroller:hasVerticalScroller:borderType:"),function(_e1,_e2,_e3,_e4,_e5,_e6){
with(_e1){
var _e7=objj_msgSend(_e1,"_insetBounds:borderType:",{origin:{x:0,y:0},size:{width:_e3.width,height:_e3.height}},_e6),_e8=objj_msgSend(CPScroller,"scrollerWidth");
if(_e4){
_e7.size.height-=_e8;
}
if(_e5){
...
}),new objj_method(sel_getUid("frameSizeForContentSize:hasHorizontalScroller:hasVerticalScroller:borderType:"),function(_e9,_ea,_eb,_ec,_ed,_ee){
with(_e9){
var _ef=objj_msgSend(_e9,"_insetBounds:borderType:",{origin:{x:0,y:0},size:{width:_eb.width,height:_eb.height}},_ee),_f0=_eb.width-_ef.size.width,_f1=_eb.height-_ef.size.height,_f2={width:_eb.width+_f0,height:_eb.height+_f1},_f3=objj_msgSend(CPScroller,"scrollerWidth");
if(_ec){
_f2.height-=_f3;
}
if(_ed){
...
}),new objj_method(sel_getUid("_insetBounds:borderType:"),function(_f4,_f5,_f6,_f7){
with(_f4){
switch(_f7){
case CPLineBorder:
case CPBezelBorder:
return {origin:{x:_f6.origin.x+1,y:_f6.origin.y+1},size:{width:_f6.size.width-2*1,height:_f6.size.height-2*1}};
case CPGrooveBorder:
_f6={origin:{x:_f6.origin.x+2,y:_f6.origin.y+2},size:{width:_f6.size.width-2*2,height:_f6.size.height-2*2}};
++_f6.origin.y;
--_f6.size.height;
return _f6;
case CPNoBorder:
...
var _f8="CPScrollViewContentView",_f9="CPScrollViewHeaderClipViewKey",_fa="CPScrollViewVLineScroll",_fb="CPScrollViewHLineScroll",_fc="CPScrollViewVPageScroll",_fd="CPScrollViewHPageScroll",_fe="CPScrollViewHasVScroller",_ff="CPScrollViewHasHScroller",_100="CPScrollViewVScroller",_101="CPScrollViewHScroller",_102="CPScrollViewAutohidesScroller",_103="CPScrollViewCornerViewKey",_104="CPScrollViewBottomCornerViewKey",_105="CPScrollViewBorderTypeKey";
var _4=objj_getClass("CPScrollView");
if(!_4){
throw new SyntaxError("*** Could not find definition for class \"CPScrollView\"");
}
var _5=_4.isa;
class_addMethods(_4,[new objj_method(sel_getUid("initWithCoder:"),function(self,_106,_107){
with(self){
if(self=objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPScrollView").super_class},"initWithCoder:",_107)){
_verticalLineScroll=objj_msgSend(_107,"decodeFloatForKey:",_fa);
_verticalPageScroll=objj_msgSend(_107,"decodeFloatForKey:",_fc);
_horizontalLineScroll=objj_msgSend(_107,"decodeFloatForKey:",_fb);
_horizontalPageScroll=objj_msgSend(_107,"decodeFloatForKey:",_fd);
_contentView=objj_msgSend(_107,"decodeObjectForKey:",_f8);
_headerClipView=objj_msgSend(_107,"decodeObjectForKey:",_f9);
if(!_headerClipView){
_headerClipView=objj_msgSend(objj_msgSend(CPClipView,"alloc"),"init");
objj_msgSend(self,"addSubview:",_headerClipView);
}
_verticalScroller=objj_msgSend(_107,"decodeObjectForKey:",_100);
_horizontalScroller=objj_msgSend(_107,"decodeObjectForKey:",_101);
_hasVerticalScroller=objj_msgSend(_107,"decodeBoolForKey:",_fe);
_hasHorizontalScroller=objj_msgSend(_107,"decodeBoolForKey:",_ff);
_autohidesScrollers=objj_msgSend(_107,"decodeBoolForKey:",_102);
_borderType=objj_msgSend(_107,"decodeIntForKey:",_105);
_cornerView=objj_msgSend(_107,"decodeObjectForKey:",_103);
_bottomCornerView=objj_msgSend(_107,"decodeObjectForKey:",_104);
_delegate=nil;
_scrollTimer=nil;
_implementedDelegateMethods=0;
...
}),new objj_method(sel_getUid("encodeWithCoder:"),function(self,_108,_109){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPScrollView").super_class},"encodeWithCoder:",_109);
objj_msgSend(_109,"encodeObject:forKey:",_contentView,_f8);
objj_msgSend(_109,"encodeObject:forKey:",_headerClipView,_f9);
objj_msgSend(_109,"encodeObject:forKey:",_verticalScroller,_100);
objj_msgSend(_109,"encodeObject:forKey:",_horizontalScroller,_101);
objj_msgSend(_109,"encodeFloat:forKey:",_verticalLineScroll,_fa);
objj_msgSend(_109,"encodeFloat:forKey:",_verticalPageScroll,_fc);
objj_msgSend(_109,"encodeFloat:forKey:",_horizontalLineScroll,_fb);
objj_msgSend(_109,"encodeFloat:forKey:",_horizontalPageScroll,_fd);
objj_msgSend(_109,"encodeBool:forKey:",_hasVerticalScroller,_fe);
objj_msgSend(_109,"encodeBool:forKey:",_hasHorizontalScroller,_ff);
objj_msgSend(_109,"encodeBool:forKey:",_autohidesScrollers,_102);
objj_msgSend(_109,"encodeObject:forKey:",_cornerView,_103);
objj_msgSend(_109,"encodeObject:forKey:",_bottomCornerView,_104);
objj_msgSend(_109,"encodeInt:forKey:",_borderType,_105);
}
})]);
...
p;12;CPScroller.jt;16786;@STATIC;1.0;i;11;CPControl.jt;16750;
objj_executeFile("CPControl.j",YES);
CPScrollerNoPart=0;
...
p;12;CPMenuItem.jt;18056;@STATIC;1.0;I;20;Foundation/CPCoder.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;9;CPImage.ji;8;CPMenu.ji;8;CPView.ji;17;_CPMenuItemView.jt;17900;
...
_isHidden=objj_msgSend(_b8,"containsValueForKey:",(_aa))?objj_msgSend(_b8,"decodeObjectForKey:",(_aa)):(NO);
_tag=objj_msgSend(_b8,"containsValueForKey:",(_ab))?objj_msgSend(_b8,"decodeObjectForKey:",(_ab)):(0);
_state=objj_msgSend(_b8,"containsValueForKey:",(_ac))?objj_msgSend(_b8,"decodeObjectForKey:",(_ac)):(CPOffState);
_image=objj_msgSend(_b8,"containsValueForKey:",(_ad))?objj_msgSend(_b8,"decodeObjectForKey:",(_ad)):(nil);
_alternateImage=objj_msgSend(_b8,"containsValueForKey:",(_ae))?objj_msgSend(_b8,"decodeObjectForKey:",(_ae)):(nil);
_menu=objj_msgSend(_b8,"containsValueForKey:",(_b0))?objj_msgSend(_b8,"decodeObjectForKey:",(_b0)):(nil);
objj_msgSend(_b6,"setSubmenu:",objj_msgSend(_b8,"containsValueForKey:",(_af))?objj_msgSend(_b8,"decodeObjectForKey:",(_af)):(nil));
_keyEquivalent=objj_msgSend(_b8,"decodeObjectForKey:",_b1)||"";
_keyEquivalentModifierMask=objj_msgSend(_b8,"decodeObjectForKey:",_b2)||0;
objj_msgSend(_b6,"setIndentationLevel:",objj_msgSend(_b8,"decodeIntForKey:",_b3)||0);
_representedObject=objj_msgSend(_b8,"containsValueForKey:",(_b4))?objj_msgSend(_b8,"decodeObjectForKey:",(_b4)):(nil);
_view=objj_msgSend(_b8,"containsValueForKey:",(_b5))?objj_msgSend(_b8,"decodeObjectForKey:",(_b5)):(nil);
}
return _b6;
}
...
p;22;_CPCibCustomResource.jt;4136;@STATIC;1.0;I;21;Foundation/CPObject.jI;21;Foundation/CPString.jt;4065;
objj_executeFile("Foundation/CPObject.j",NO);
objj_executeFile("Foundation/CPString.j",NO);
...
var _14=_properties.valueForKey("bundleClass"),_15=nil;
if(_14){
_14=CPClassFromString(_14);
if(_14){
_15=objj_msgSend(CPBundle,"bundleForClass:",_14);
}
}
return objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend((_15||objj_msgSend(_13,"bundle")),"pathForResource:",_resourceName),_properties.valueForKey("size"));
}
}
return _11;
}
})]);
class_addMethods(_5,[new objj_method(sel_getUid("imageResourceWithName:size:"),function(_16,_17,_18,_19){
with(_16){
return objj_msgSend(objj_msgSend(_16,"alloc"),"initWithClassName:resourceName:properties:","CPImage",_18,objj_msgSend(CPDictionary,"dictionaryWithObject:forKey:",_19,"size"));
}
}),new objj_method(sel_getUid("imageResourceWithName:size:bundleClass:"),function(_1a,_1b,_1c,_1d,_1e){
with(_1a){
return objj_msgSend(objj_msgSend(_1a,"alloc"),"initWithClassName:resourceName:properties:","CPImage",_1c,objj_msgSend(CPDictionary,"dictionaryWithObjects:forKeys:",[_1d,_1e],["size","bundleClass"]));
}
})]);
...
var _5=_4.isa;
class_addMethods(_4,[new objj_method(sel_getUid("filename"),function(_1f,_20){
with(_1f){
...
}),new objj_method(sel_getUid("isThreePartImage"),function(_23,_24){
with(_23){
return NO;
}
}),new objj_method(sel_getUid("isNinePartImage"),function(_25,_26){
with(_25){
return NO;
}
}),new objj_method(sel_getUid("loadStatus"),function(_27,_28){
with(_27){
return CPImageLoadStatusCompleted;
}
}),new objj_method(sel_getUid("delegate"),function(_29,_2a){
with(_29){
return nil;
}
})]);
...
p;15;CPPopUpButton.jt;16125;@STATIC;1.0;i;10;CPButton.ji;12;CPGeometry.ji;8;CPMenu.ji;12;CPMenuItem.jt;16044;
objj_executeFile("CPButton.j",YES);
objj_executeFile("CPGeometry.j",YES);
objj_executeFile("CPMenu.j",YES);
objj_executeFile("CPMenuItem.j",YES);
...
}),new objj_method(sel_getUid("selectedTag"),function(_33,_34){
with(_33){
...
class_addMethods(_3,[new objj_method(sel_getUid("defaultThemeClass"),function(_b2,_b3){
with(_b2){
return "popup-button";
}
}),new objj_method(sel_getUid("keyPathsForValuesAffectingSelectedIndex"),function(_b4,_b5){
with(_b4){
return objj_msgSend(CPSet,"setWithObject:","objectValue");
}
}),new objj_method(sel_getUid("keyPathsForValuesAffectingSelectedTag"),function(_b6,_b7){
with(_b6){
return objj_msgSend(CPSet,"setWithObject:","objectValue");
}
}),new objj_method(sel_getUid("keyPathsForValuesAffectingSelectedItem"),function(_b8,_b9){
with(_b8){
return objj_msgSend(CPSet,"setWithObject:","objectValue");
}
})]);
var _ba="CPPopUpButtonMenuKey",_bb="CPPopUpButtonSelectedIndexKey";
var _2=objj_getClass("CPPopUpButton");
if(!_2){
throw new SyntaxError("*** Could not find definition for class \"CPPopUpButton\"");
}
var _3=_2.isa;
class_addMethods(_2,[new objj_method(sel_getUid("initWithCoder:"),function(_bc,_bd,_be){
with(_bc){
_bc=objj_msgSendSuper({receiver:_bc,super_class:objj_getClass("CPPopUpButton").super_class},"initWithCoder:",_be);
if(_bc){
objj_msgSend(_bc,"synchronizeTitleAndSelectedItem");
if(objj_msgSend(_be,"containsValueForKey:",_ba)){
CPLog.warn(_bc+" was encoded with an older version of Cappuccino. Please nib2cib the original nib again or open and re-save in Atlas.");
objj_msgSend(_bc,"setMenu:",objj_msgSend(_be,"decodeObjectForKey:",_ba));
objj_msgSend(_bc,"setObjectValue:",objj_msgSend(_be,"decodeObjectForKey:",_bb));
}
var _bf=CPKeyValueObservingOptionNew|CPKeyValueObservingOptionOld;
objj_msgSend(_bc,"addObserver:forKeyPath:options:context:",_bc,"menu.items",_bf,nil);
objj_msgSend(_bc,"addObserver:forKeyPath:options:context:",_bc,"_firstItem.changeCount",_bf,nil);
objj_msgSend(_bc,"addObserver:forKeyPath:options:context:",_bc,"selectedItem.changeCount",_bf,nil);
}
return _bc;
}
})]);
...
p;18;_CPCibObjectData.jt;6675;@STATIC;1.0;I;20;Foundation/CPArray.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;7;CPCib.ji;16;CPCibConnector.ji;23;CPCibControlConnector.ji;22;CPCibOutletConnector.ji;23;CPCibBindingConnector.ji;33;CPCibRuntimeAttributesConnector.jt;6426;
objj_executeFile("Foundation/CPArray.j",NO);
objj_executeFile("Foundation/CPObject.j",NO);
objj_executeFile("Foundation/CPString.j",NO);
objj_executeFile("CPCib.j",YES);
...
if(objj_msgSend(_31,"isKindOfClass:",objj_msgSend(CPCibRuntimeAttributesConnector,"class"))){
_30.push(_31);
}else{
...
_maxSize=CGSizeMake(MAX(_labelSize.width,_bc.width),100000000);
