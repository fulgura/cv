@STATIC;1.0;p;13;CPArray+KVO.jt;19452;@STATIC;1.0;i;9;CPArray.ji;8;CPNull.jt;19407;objj_executeFile("CPArray.j", YES);
...
kvoOperators["distinctUnionOfObjects"] = distinctUnionOfObjectsOperator= function(self, _cmd, param)
{
    var objects = objj_msgSend(self, "valueForKeyPath:", param);
    return objj_msgSend(objj_msgSend(CPSet, "setWithArray:", objects), "allObjects");
}
kvoOperators["unionOfObjects"] = unionOfObjectsOperator= function(self, _cmd, param)
{
    return objj_msgSend(self, "valueForKeyPath:", param);
}
{
var the_class = objj_getClass("CPArray")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPArray\"");
